...
$f = new Form("obat11.php", "GET", "NAME=Form1");
$f->PgConn = $con;
...
// search box
echo "<DIV ALIGN=RIGHT><TABLE BORDER=0><FORM ACTION='obat11.php'><TR>";
// tambahan 3
...
$t->ColFormatHtml[0] =
    "<A HREF='obat11.php?e=<#0#>&nomor_bukti=".$_GET["nomor_bukti"]."&mOBT=".$_GET[mOBT]."'><IMG BORDER=0 SRC='../images/icon-ok.png'></A>";
