...
title("Pilih Kategori Barang (Stok Apotek Cinduo Mato)");
echo "<br>";
...
$f = new Form("obat_apotek_cdm.php", "GET", "NAME=Form1");
$f->PgConn = $con;
...
// search box
echo "<DIV ALIGN=RIGHT><TABLE BORDER=0><FORM ACTION='obat_apotek_cdm.php'><TR>";
// tambahan 3
...
$t->SQL =   "select a.id, a.id, a.obat, a.satuan, x.qty_jiwa   ".            
			...
			group by a.id, a.obat, a.satuan,  x.qty_jiwa  ";
$t->setlocale("id_ID");
...
$t->ColFormatHtml[0] =
    "<A HREF='obat_apotek_cdm.php?e=<#0#>&nomor_bukti=".$_GET["nomor_bukti"]."&mOBT=".$_GET[mOBT]."'><IMG BORDER=0 SRC='../images/icon-ok.png'></A>";
$t->ColHeader = Array("&nbsp;", "ID<br>OBAT","KETERANGAN", "SATUAN", "STOK<br>CINDUO MATO");
