...
$SQL1 = "select a.id, a.kode, a.nama, a.akun_type ".
...
$t->RowsPerPage = 10;
$t->ColFormatHtml[0] =
    "<A HREF='akun1.php?e=<#1#>'><IMG BORDER=0 SRC='../images/icon-ok.png'></A>";
$t->ColHeader = Array("&nbsp;", "KODE", "AKUN", "DEBET/KREDIT");
//$t->ShowSQL = true;
$t->execute();
...
$t = new PgTable($con, "100%");
$SQL="select kode, kode, nama, akun_type 
     from akun_master where is_group='N' and upper(nama) LIKE '%".strtoupper($_GET["search"])."%'
      group by kode, nama, akun_type ";
$t->SQL = $SQL;
//$t->SQLCounter = $SQL1Counter;
$t->setlocale("id_ID");
$t->RowsPerPage = 15;
