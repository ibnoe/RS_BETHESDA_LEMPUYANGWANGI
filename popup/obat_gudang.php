...
$f = new Form("obat_gudang.php", "GET", "NAME=Form1");
$f->PgConn = $con;
...
// search box
echo "<DIV ALIGN=RIGHT><TABLE BORDER=0><FORM ACTION='obat_gudang.php'><TR>";
// tambahan 3
...
$t->SQL =   "select a.id, a.obat, a.satuan, x.gudang ".
			...
			group by a.id, a.obat, a.satuan, x.gudang
			";
$t->setlocale("id_ID");
...
$t->ColFormatHtml[0] =
    "<A HREF='obat_gudang.php?e=<#0#>&nomor_bukti=".$_GET["nomor_bukti"]."&mOBT=".$_GET[mOBT]."'><IMG BORDER=0 SRC='../images/icon-ok.png'></A>";
$t->ColHeader = Array("&nbsp;", "KETERANGAN", "SATUAN", "STOK GUDANG","STOK<br>APOTEK/BANGSAL");
