...
title("Pilih Kategori Barang (Bangsal ICU)");
echo "<br>";
...
$f = new Form("obat5rck.php", "GET", "NAME=Form1");
$f->PgConn = $con;
...
// search box
echo "<DIV ALIGN=RIGHT><TABLE BORDER=0><FORM ACTION='obat5rck.php'><TR>";
// tambahan 3
...
$t->SQL =   "select a.id, a.obat, a.satuan, (x.qty_apotek5) as sisa ".
			...
			group by a.id, a.obat, a.satuan, x.qty_apotek5 
			";
$t->setlocale("id_ID");
...
$t->ColFormatHtml[0] =
    "<A HREF='obat5rck.php?e=<#0#>&nomor_bukti=".$_GET["nomor_bukti"]."&mOBT=".$_GET[mOBT]."'><IMG BORDER=0 SRC='../images/icon-ok.png'></A>";
