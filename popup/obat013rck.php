...
unset($_SESSION["SELECT_OBAT_RACIKAN"]);
/*
if (isset($_GET["e"])) {
	if ($_GET["n"] == 0){
	    $_SESSION["SELECT_OBAT_RACIKAN"] = $_GET["e"];
	    ?>
...
title("Pilih Kategori Barang (Bangsal RAWAT INAP MATA)");
echo "<br>";
...
$f = new Form("obat13rck.php", "GET", "NAME=Form1");
$f->PgConn = $con;
...
// search box
echo "<DIV ALIGN=RIGHT><TABLE BORDER=0><FORM ACTION='obat13rck.php'><TR>";
// tambahan 3
...
$t->SQL =   "select a.id, a.obat, a.satuan, (x.qty_operasi) as sisa ".
			...
			group by a.id, a.obat, a.satuan, x.qty_operasi  
			";
$t->setlocale("id_ID");
...
$t->ColFormatHtml[0] =
    "<A HREF='obat13rck.php?e=<#0#>&nomor_bukti=".$_GET["nomor_bukti"]."&mOBT=".$_GET[mOBT]."'><IMG BORDER=0 SRC='../images/icon-ok.png'></A>";
