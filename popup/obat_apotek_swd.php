...
$t->SQL =   "select a.id, a.id, a.obat, a.satuan, x.qty_ri, a.harga   ".            
			...
			group by a.id, a.obat, a.satuan,  x.qty_ri, a.harga  ";
$t->setlocale("id_ID");
...
$t->ColFormatHtml[0] =
    "<A HREF='obat_apotek_swd.php?e=<#0#>&nomor_bukti=".$_GET["nomor_bukti"]."&mOBT=".$_GET[mOBT]."'><IMG BORDER=0 SRC='../images/icon-ok.png'></A>";
$t->ColHeader = Array("&nbsp;", "ID<br>OBAT","KETERANGAN", "SATUAN", "STOK<br>APOTEK", "HARGA");
