...
title("Pilih Kategori Barang (Bangsal THT)");
echo "<br>";
...
$f = new Form("obat14rck.php", "GET", "NAME=Form1");
$f->PgConn = $con;
...
// search box
echo "<DIV ALIGN=RIGHT><TABLE BORDER=0><FORM ACTION='obat14rck.php'><TR>";
// tambahan 3
...
$t->SQL =   "select a.id, a.obat, a.satuan, (x.qty_radio) as sisa ".
			...
			group by a.id, a.obat, a.satuan, x.qty_radio  
			";
$t->setlocale("id_ID");
...
$t->ColFormatHtml[0] =
    "<A HREF='obat14rck.php?e=<#0#>&nomor_bukti=".$_GET["nomor_bukti"]."&mOBT=".$_GET[mOBT]."'><IMG BORDER=0 SRC='../images/icon-ok.png'></A>";
