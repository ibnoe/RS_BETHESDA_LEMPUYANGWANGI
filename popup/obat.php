...
$f = new Form("obat.php", "GET", "NAME=Form1");
$f->PgConn = $con;
...
// search box
echo "<DIV ALIGN=RIGHT><TABLE BORDER=0><FORM ACTION='obat.php'><TR>";
// tambahan 3
...
if(!empty($_GET['mOBT'])){
$mOBT = "a.kategori_id ='".$_GET["mOBT"]."' and ";
}

$t = new PgTable($con, "100%");
$t->SQL =   "select a.id, a.obat, a.satuan, x.qty_ri ".
...
$t->ColFormatHtml[0] =
    "<A HREF='obat.php?e=<#0#>&nomor_bukti=".$_GET["nomor_bukti"]."&mOBT=".$_GET[mOBT]."'><IMG BORDER=0 SRC='../images/icon-ok.png'></A>";
$t->ColHeader = Array("&nbsp;", "OBAT", "SATUAN", "STOK FARMASI","STOK<br>APOTEK/BANGSAL");
