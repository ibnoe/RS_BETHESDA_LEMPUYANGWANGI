...
<head>
    ...
    <script language="javascript">
		...
		select: function( event, ui ) {
			$("input:hidden[name='bangsal_id']").val(ui.item.id);
...
<table width="100%">
	<tr>
		<input type="hidden" name="bangsal_id" value="<?php echo $row['bangsal_id'];?>" />
	...
	<tr>
		<td><b>Harga</b></td><td>:</td><td><input id ="harga" name="harga" style="text-align:right;" type="text" value="<?php echo $row['harga'];?>" readonly size="35" /></td>
	</tr>
	<tr>
		<td><b>Tagihan</b></td><td>:</td><td><input style="text-align:right;" type="text" id="tagihan" name="tagihan" value="<?php echo $row['tagihan'];?>" readonly size="35"  /></td>
	</tr>
	<tr>
		<td><b>Dibayar Penjamin</b></td><td>:</td><td><input style="text-align:right;" type="text" id="dibayar_penjamin" name="dibayar_penjamin" value="<?php echo (double)$row['dibayar_penjamin'];?>" size="35" /></td>
	</tr>
	<tr>
		<td><b>Diskon (%)</b></td><td>:</td><td><input name="persen" id="persen" style="text-align:right;" type="text" value="<?php echo $row['persen'];?>" size="35" /></td>
	</tr>
	<tr>
		<td><b>Diskon (Rp.)</b></td><td>:</td><td><input id="diskon" name="diskon" style="text-align:right;" type="text" value="<?php echo $row['diskon'];?>" size="35" /></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
