...
<body onload="init('<?php echo $set_base_url?>', '<?php echo $set_idle_time?>')" bgcolor="#ffffff" background="images/akta_lahir.jpg">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr valign="top">
    ...
    $t->execute();
			...
			$SQLSTR = "select c.id,upper(b.nama)as nama, b.umur, ".
	   ...
	   "	 left join rs00001 g on g.tc = b.tipe_pasien and g.tt='JEP' ".
          "where a.ts_calc_stop is null group by c.id,b.nama,b.umur,f.bangsal,e.bangsal,d.bangsal,a.ts_check_in";          

$te = new PgTable($con, "100%");
$te->SQL = "$SQLSTR";
           $_GET[sort] = "a.ts_check_in";
           $_GET[order] = "desc";
$te->ColHeader = array("NO. REG","NAMA", "UMUR", "RUANGAN");
$te->ShowRowNumber = true;
$te->ColAlign[0] = "CENTER";
$te->ColAlign[1] = "LEFT";
$te->ColAlign[2] = "CENTER";
$te->ColAlign[3] = "LEFT";
$te->RowsPerPage = 15;
$te->execute();
                        }else{
