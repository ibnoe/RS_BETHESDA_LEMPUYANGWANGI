...
$no_faktur = getFromTable("select no_faktur from c_po_gudang where id_po_gd='".$_GET["po_id"]."' ");
...
$id_sup=getFromTable("select supplier from c_po_gudang  where id_po_gd='".$_GET["po_id"]."'");
$nama_sup=getFromTable("select nama from rs00028  where id='$id_sup'");
...
<br>
	...
	<tr>
        ...
        <td><B>NO. FAKTUR</B></td>
        <td><B>&nbsp;:&nbsp;</B></td>
        <td><B><?echo $no_faktur;?></B></td>
    </tr><tr>
        <td>&nbsp;&nbsp;&nbsp;</td>
        <td><B>SUPPLIER</B></td>
        <td><B>&nbsp;:&nbsp;</B></td>
        <td><B><?echo $nama_sup;?></B></td>
    </tr><tr>
        <td>&nbsp;&nbsp;&nbsp;</td>
