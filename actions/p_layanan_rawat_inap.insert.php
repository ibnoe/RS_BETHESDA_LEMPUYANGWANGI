...
if (is_array($_SESSION["layanan"])) {
   ...
   pg_query("INSERT INTO rs00005 VALUES( currval('kasir_seq'), '".$_POST["rg"]."', ".
    ...
    foreach ($_SESSION["layanan"] as $v) {
        ...
        //$tr->addSQL("update c_visit set id_dokter=$dokter where no_reg = '".$_POST["rg"]."' ");
    }
...
if (isset($_POST["byr"])) {
    ...
    $tr->addSQL(
        ...
        //insert c_vis_layanan_rawat_inap
	...
	if ($_POST['act'] == "edit") { 
		...
		//if ($_POST['row'] > 0)	{
			...
			if ($d2 = pg_fetch_object($r2)){		
				...
				header("Location: ../index2.php?p=$PID&list={$_POST["list"]}&rg=$noreg&ri=".$_POST["f_id_ri"]."&mr=".$_POST["mr"]);
				exit;
			}
	}
//--------------------------------------------------------	
...
if ($tr->execute()) {
    ...
    unset($_SESSION["icd"]);
    if($_POST['sub'] != "retur"){  
    header("Location: ../index2.php?p=$PID&list={$_POST["list"]}&rg=".$_POST[rg]."&ri=".$_POST["f_id_ri"]."&mr=".$_GET["mr"]."&sub=".$_POST[sub]);
    exit;
    }else{
    	header("Location: ../index2.php?p=$PID&list={$_POST["list"]}&rg=".$_POST[rg]."&ri=".$_POST["f_id_ri"]."&mr=".$_GET["mr"]."&sub=".$_POST[sub]);
    exit;
