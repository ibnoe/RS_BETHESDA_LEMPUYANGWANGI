...
if (is_array($_SESSION["ob6"]["obat"])) {
    ...
    foreach ($_SESSION["ob6"]["obat"] as $v) {
        $tr->addSQL(
            "insert into rs00008 (" .
            ...
            ") values (".
                "nextval('rs00008_seq'), 'OB6', '$PID', currval('rs00008_seq_group'), CURRENT_DATE, " .
                "CURRENT_DATE, CURRENT_TIME, '".$_SESSION["ob6"]["supplier"]["id"]."', '".$v["id"]."', '".$_SESSION["ob6"]["nomor-bukti"]."', " .
