...
if ($_SESSION[uid] == "kasir1") {
    $kasir = "RJL";
    $lyn = getFromTable("select layanan from rs00005 where reg='".$_GET[rg]."' and layanan not in (997,998,999)");
...
$SQL2 = "insert into history_user " .
            ...
            "values".
            "(nextval('rshistory_user_seq'),CURRENT_DATE,CURRENT_TIME,'Pelayanan IGD','Pelayanan -> Instalasi Gawat Darurat','Menghapus Pelayanan Paket No.MR $mr No.REG $rg Total $jml','".$_SESSION["uid"]."','".$_SESSION["nama_usr"]."')";
pg_query($con, $SQL2);
//======================
...
$SQL2 = "insert into history_user " .
            "(id_history, tanggal_entry,waktu_entry,trans_form,item_id,keterangan,user_id,nama_user) ".
            "values".
            "(nextval('rshistory_user_seq'),CURRENT_DATE,CURRENT_TIME,'Poli IGD','Pelayanan -> Instalasi Gawat Darurat','Menghapus Pelayanan Non Paket No.MR $mr No.REG $rg Total $jml','".$_SESSION["uid"]."','".$_SESSION["nama_usr"]."')";
    pg_query($con, $SQL2);
//======================
    ...
    pg_query(	"insert into rs00005 (id, reg, tgl_entry, kasir, is_obat, ".
	    		"is_karcis, layanan, jumlah, is_bayar) ".
	    		"values (nextval('kasir_seq'), '".$_GET[rg]."', CURRENT_DATE, '$kasir', 'Y', 'N', 997, $jmlx, 'N') ");
...
header("Location: ../index2.php?p=$PID&list=layanan&rg=".$_GET["rg"]."&poli=".$_POST["f_id_poli"]."&mr=".$_GET["mr"]."$add");
exit;
