...
function cetakBHP(reg) {
    ...
    sWin = window.open('includes/cetak.rincian_bhp.php?rg='+reg+''+checkedPrint, 'xWin','top=0,left=0,width=750,height=550,menubar=no,location=no,scrollbars=yes');
    sWin.focus();
}
function cetakBHPreturn(reg) {
    ...
    sWin = window.open('includes/cetak.rincian_bhp_return.php?rg='+reg+''+checkedPrint, 'xWin','top=0,left=0,width=750,height=550,menubar=no,location=no,scrollbars=yes');
    sWin.focus();
}
</script>