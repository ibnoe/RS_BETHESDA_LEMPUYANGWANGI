...
if (is_array($_SESSION["layanan"])) {
   ...
   // insert to rs00005
   // -------------ditutup dulu yah bentar. mau di cek dulu soalnya-------------------
...
if (is_array($_SESSION["obat"])) {
   ...
   //---------------sori di tutup dulu yah. bentar aja--------------
   //pg_query("INSERT INTO rs00005 VALUES( currval('kasir_seq'), '".$_POST["rg"]."', ".
   //     "CURRENT_DATE, '$loket', 'Y', 'N', 99997, $total, 'N')") or die("eror atuh");
   // end tokit punya // tokit-tokitlah. lieur aing ngeditna....
...
if ($tr->execute()) {
    ...
    */
	...
	header("Location: ../index2.php?p=p_igd&list=resepobat&rg=".$_POST[rg]."&sub=".$_POST[sub]."&mr=".$_POST[mr]);
