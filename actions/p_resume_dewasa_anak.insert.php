	...
	if ($_POST['act'] == "edit") { 
		...
		//if ($_POST['row'] > 0)	{
			...
			if ($d2 = pg_fetch_object($r2)){		
				...
				pg_query($con, $SQL);
				pg_query("update c_visit_ri set id_dokter='{$_POST["f_id_dokter"]}',id_perawat='{$_POST["f_id_perawat"]}' where no_reg ='$noreg'and id_ri = '{$_POST["f_id_ri"]}' 
                                          and tanggal_reg = '".$_POST["f_tanggal_reg"]."' ");
