...
$SQL2 = "insert into history_user " .
            ...
            "values".
            "(nextval('rshistory_user_seq'),CURRENT_DATE,CURRENT_TIME,'Poli Saraf','Pelayanan -> Poliklinik Saraf','Menghapus Pelayanan Paket No.MR $mr No.REG $rg Total $jml','".$_SESSION["uid"]."','".$_SESSION["nama_usr"]."')";
pg_query($con, $SQL2);
//======================
	} elseif ($_GET[tbl] == "bhp") {
    $add = "&sub2=bhp";
...
$SQL2 = "insert into history_user " .
            "(id_history, tanggal_entry,waktu_entry,trans_form,item_id,keterangan,user_id,nama_user) ".
            "values".
            "(nextval('rshistory_user_seq'),CURRENT_DATE,CURRENT_TIME,'Poli Saraf','Pelayanan -> Poliklinik Saraf','Menghapus Pelayanan Non Paket No.MR $mr No.REG $rg Total $jml','".$_SESSION["uid"]."','".$_SESSION["nama_usr"]."')";
    pg_query($con, $SQL2);
//======================
...
header("Location: ../index2.php?p=$PID&list=konsultasi&rg=".$_GET["rg"]."&poli=108&mr=".$_GET["mr"]."$add");
}else{
header("Location: ../index2.php?p=$PID&list=layanan&rg=".$_GET["rg"]."&poli=108&mr=".$_GET["mr"]."$add");
}
exit;
