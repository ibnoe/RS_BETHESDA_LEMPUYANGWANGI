...
$SQL2 = "insert into history_user " .
            ...
            "values".
            "(nextval('rshistory_user_seq'),CURRENT_DATE,CURRENT_TIME,'Poli Kulit & Kelamin','Pelayanan -> Poliklinik Kulit & Kelamin','Menambah Pelayanan NonPaket No.MR $mr No.REG $rg Total ".$v["total"]."','".$_SESSION["uid"]."','".$_SESSION["nama_usr"]."')";
pg_query($con, $SQL2);
//======================
...
$SQL2 = "insert into history_user " .
            "(id_history, tanggal_entry,waktu_entry,trans_form,item_id,keterangan,user_id,nama_user) ".
            "values".
            "(nextval('rshistory_user_seq'),CURRENT_DATE,CURRENT_TIME,'Poli Kulit & Kelamin','Pelayanan -> Poliklinik Kulit & Kelamin','Menambah Pelayanan Paket No.MR $mr No.REG $rg Total ".$v["total"]."','".$_SESSION["uid"]."','".$_SESSION["nama_usr"]."')";
pg_query($con, $SQL2);
//======================
    }
...
$SQL2 = "insert into history_user " .
            "(id_history, tanggal_entry,waktu_entry,trans_form,item_id,keterangan,user_id,nama_user) ".
            "values".
            "(nextval('rshistory_user_seq'),CURRENT_DATE,CURRENT_TIME,'Poli Kulit Dan Kelamin','Pelayanan -> Poliklinik Kulit Dan Kelamin','Menambah BHP No.MR $mr No.REG $rg Total ".$v["total"]."','".$_SESSION["uid"]."','".$_SESSION["nama_usr"]."')";
pg_query($con, $SQL2);
//======================
    }  
	...
	if ($_POST['act'] == "edit") { 
		...
		//if ($_POST['row'] > 0)	{
			...
			if ($d2 = pg_fetch_object($r2)){		
				...
				pg_query($con, $SQL);
				pg_query("update c_visit set vis_12='{$_POST["check1"]}',vis_13='{$_POST["check2"]}' where no_reg ='$noreg'");
...
//--------------------------------------------------------	
	if ($_POST['act'] == "new") { 	
			...
			//echo $SQL;
			pg_query($con, $SQL);
			$SQL1 =("update c_visit set vis_12='{$_POST["check1"]}',vis_13='{$_POST["check2"]}' where no_reg ='$noreg'");
			pg_query($con, $SQL1);
...
if ($tr->execute()) {
    ...
    unset($_SESSION["icd"]);
    if($_POST['sub'] != "retur"){  
    header("Location: ../index2.php?p=$PID&list={$_POST["list"]}&rg=".$_POST[rg]."&poli=109&mr=".$_GET["mr"]."$add&sub=".$_POST[sub]);
    exit;
    }else{
    	header("Location: ../index2.php?p=$PID&list={$_POST["list"]}&rg=".$_POST[rg]."&poli=109&mr=".$_GET["mr"]."$add&sub=".$_POST[sub]);
    exit;
