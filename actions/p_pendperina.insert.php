...
//--------------------------------------------------------	
	if ($_POST['act'] == "new") { 	
			...
			*/
			...
			pg_query("update rs00006 set tanggal_layanan=CURRENT_DATE where id ='$noreg'");
			pg_query("update rs00006 set waktu_layanan=CURRENT_TIME where id ='$noreg'");
	...
	if ($_POST['act'] == "new2") { 	
			...
			if ($knsl==""){
			pg_query("update c_visit set id_konsul='".$_POST["konsultasi"]."' where no_reg ='$noreg' and id_poli ='".$_POST["f_id_poli"]."'");
			pg_query("update c_visit set tanggal_konsul=CURRENT_DATE where no_reg ='$noreg' and id_poli ='".$_POST["f_id_poli"]."'");//Add Date&Time konsul
			...
			$SQLa="insert into c_visit (no_reg,tanggal_reg,id_poli,id_konsul,id_dokter,tanggal_konsul,waktu_konsul) 
