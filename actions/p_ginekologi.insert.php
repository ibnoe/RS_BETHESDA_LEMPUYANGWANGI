...
$SQL2 = "insert into history_user " .
            ...
            "values".
            "(nextval('rshistory_user_seq'),CURRENT_DATE,CURRENT_TIME,'Poli Kebidanan Ginekologi','Pelayanan -> Poliklinik Kebidanan Ginekologi','Menambah Pelayanan NonPaket No.MR $mr No.REG $rg Total ".$v["total"]."','".$_SESSION["uid"]."','".$_SESSION["nama_usr"]."')";
pg_query($con, $SQL2);
//======================
...
$SQL2 = "insert into history_user " .
            "(id_history, tanggal_entry,waktu_entry,trans_form,item_id,keterangan,user_id,nama_user) ".
            "values".
            "(nextval('rshistory_user_seq'),CURRENT_DATE,CURRENT_TIME,'Poli Kebidanan Ginekologi','Pelayanan -> Poliklinik Kebidanan Ginekologi','Menambah Pelayanan Paket No.MR $mr No.REG $rg Total ".$v["total"]."','".$_SESSION["uid"]."','".$_SESSION["nama_usr"]."')";
pg_query($con, $SQL2);
//======================
    }
	// Insert BHP
...
$SQL2 = "insert into history_user " .
            "(id_history, tanggal_entry,waktu_entry,trans_form,item_id,keterangan,user_id,nama_user) ".
            "values".
            "(nextval('rshistory_user_seq'),CURRENT_DATE,CURRENT_TIME,'Poli KEBIDANAN (GINEKOLOGI)','Pelayanan -> Poliklinik KEBIDANAN (GINEKOLOGI)','Menambah BHP No.MR $mr No.REG $rg Total ".$v["total"]."','".$_SESSION["uid"]."','".$_SESSION["nama_usr"]."')";
pg_query($con, $SQL2);
//======================
    }  
	...
	if ($_POST['act'] == "edit") {
		...
		//if ($_POST['row'] > 0)	{
			...
			if ($d2 = pg_fetch_object($r2)){		
				...
				pg_query($con, $SQL);
				pg_query("update c_visit set vis_9='{$_POST["check1"]}',vis_10='{$_POST["check2"]}',vis_11='{$_POST["check3"]}',vis_12='{$_POST["check4"]}',
				vis_13='{$_POST["check5"]}',vis_14='{$_POST["check6"]}',vis_42='{$_POST["check7"]}',
				vis_43='{$_POST["check8"]}',vis_44='{$_POST["check9"]}',vis_45='{$_POST["check10"]}' where no_reg ='$noreg'");
...
if ($tr->execute()) {
    ...
    unset($_SESSION["icd"]);
    if($_POST['sub'] != "retur"){  
    header("Location: ../index2.php?p=$PID&list={$_POST["list"]}&rg=".$_POST[rg]."&poli=115&mr=".$_GET["mr"]."$add&sub=".$_POST[sub]);
    exit;
    }else{
    	header("Location: ../index2.php?p=$PID&list={$_POST["list"]}&rg=".$_POST[rg]."&poli=115&mr=".$_GET["mr"]."$add&sub=".$_POST[sub]);
    exit;
