...
$reg=$_POST['no_reg'];
//var_dump($reg); die();	
    $SQL = "update rs00044 set tgl_deposit=CURRENT_DATE,wkt_deposit=CURRENT_TIME,nm_pasien='".$_POST[nama]."',bangsal='".$_POST[bangsal]."',no_kartu='".$_POST[no_kartu]."',jumlah=".$_POST[jumlah].",pembayar='".$_POST[pembayar]."',kasir='".$_POST[kasir]."' where no_reg='$reg'";
