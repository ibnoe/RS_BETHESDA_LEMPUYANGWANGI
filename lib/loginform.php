...
class Form
{
    ...
    {
        $this->b .= "<TABLE BORDER=0 CELLSPACING=10 CELLPADDING=0>\n";
    ...
    function search($name, $capt, $size, $maxlength, $defval, $src,$alt, $ext = "")
    {
        ...
        $this->b .= "<TD CLASS=FORM>:</TD>\n";
        $this->b .= "<TD CLASS=FORM VALIGN='ABSMIDDLE'><INPUT TYPE=TEXT NAME=$name SIZE=$size MAXLENGTH=$maxlength $ext VALUE='$defval'></TD>\n";
    ...
    function textarea1($name, $capt, $rows, $cols, $defval, $ext = "")
    {
        $this->b .= "<TR>\n";
        $this->b .= "<TR>\n<TD COLSPAN='6' ALIGN=LEFT CLASS=FORM_SUBTITLE1></TD></TR>\n";
        $this->b .= "<TD width='157' CLASS=FORM>$capt</TD>\n";
        $this->b .= "<TD CLASS=FORM>:</TD>\n";
    ...
    function text_5($name, $capt, $size, $maxlength, $defval,$info, $name2, $capt2, $size2, $maxlength2, $defval2,
    ...
    function text_mata($gbr1,$judul,$gbr2,$name0,$maxlength0,$defval0,$name1,$maxlength1,$defval1,$name,$maxlength,$defval,$name2,$maxlength2,$defval2,$name3,$maxlength3,$defval3,$name4,$maxlength4,$defval4,$name5,
    			    ...
    			    $name7, $capt7, $size7, $maxlength7, $defval7,$info7,$name8, $capt8, $size8, $maxlength8, $defval8,$info8,$ext = "")
    {
		...
		$this->b .= "<TD WIDTH=150 CLASS=FORM>$capt4</TD>\n";
        $this->b .= "<TD CLASS=FORM>:</TD>\n";
        $this->b .= "<TD CLASS=FORM ><INPUT TYPE=TEXT NAME=$name4 SIZE=$size4 ".
                    "MAXLENGTH=$maxlength4 $ext VALUE='$defval4'>&nbsp;$info4</TD></TR>\n";
  
    	$this->b .= "<TR><TD WIDTH=150 CLASS=FORM>$capt5</TD>\n";
        $this->b .= "<TD CLASS=FORM>:</TD>\n";
        $this->b .= "<TD CLASS=FORM ><INPUT TYPE=TEXT NAME=$name5 SIZE=$size5 ".
                    "MAXLENGTH=$maxlength5 $ext VALUE='$defval5'>&nbsp;$info5</TD>\n";
    ...
    function radio_btn($capt,$name1,$capt1,$val1,$name2,$capt2,$val2,$ext = "")
    {
        ...
        $this->b .= "<TD CLASS=FORM>:</TD>\n";
        $this->b .= "<TD WIDTH=102 CLASS=FORM valign=$valign><INPUT $ext TYPE=RADIO NAME=$name1 VALUE='$val1' ></TD>\n";
        $this->b .= "<TD WIDTH=102 CLASS=FORM valign=$valign><INPUT $ext TYPE=RADIO NAME=$name2 VALUE='$val2' ></TD>\n";
        $this->b .= "</TR></TABLE><TABLE CELLSPACING=2 CELLPADDING=2>\n\n";
    ...
    function checkbox3($capt,$name1,$capt1,$val1,$check1,$name2,$capt2,$val2,$check2,$name3,$capt3,$val3,$check3,$ext = "")
    {
    	...
    	$this->b .= "<TD WIDTH=157 CLASS=FORM valign=$valign>$capt</TD>\n";
        $this->b .= "<TD CLASS=FORM>:</TD>\n";
        $this->b .= "<TD CLASS=FORM valign=$valign><INPUT $ext TYPE=CHECKBOX NAME=$name1 VALUE=$val1 $check1>$capt1&nbsp;(0)</TD>\n";
        $this->b .= "<TD CLASS=FORM valign=$valign><INPUT $ext TYPE=CHECKBOX NAME=$name2 VALUE=$val2 $check2>$capt2&nbsp;(1)</TD>\n";
        $this->b .= "<TD CLASS=FORM valign=$valign><INPUT $ext TYPE=CHECKBOX NAME=$name3 VALUE=$val3 $check3>$capt3&nbsp;(2)</TD>\n";
        $this->b .= "</TR></TABLE><TABLE CELLSPACING=2 CELLPADDING=2>\n\n";
    ...
    function checkbox1($capt,$name,$capt1,$val1,$check1,$capt2,$val2,$check2,$capt3,$val3,$check3,$ext="")
    {
        ...
        $this->b .= "<TD CLASS=FORM>:</TD>\n";
        $this->b .= "<TD WIDTH=102 CLASS=FORM valign=$valign><INPUT $ext TYPE=CHECKBOX NAME=$name VALUE=$val1 $check1>$capt1</TD>\n";
        $this->b .= "<TD WIDTH=102 CLASS=FORM valign=$valign><INPUT $ext TYPE=CHECKBOX NAME=$name VALUE=$val2 $check2>$capt2</TD>\n";
        $this->b .= "<TD WIDTH=102 CLASS=FORM valign=$valign><INPUT $ext TYPE=CHECKBOX NAME=$name VALUE=$val3 $check3>$capt3</TD>\n";
        $this->b .= "</TR></TABLE><TABLE CELLSPACING=2 CELLPADDING=2>\n\n";
    ...
    function checkbox4($capt,$name,$capt1,$val1,$check1,$capt2,$val2,$check2,$capt3,$val3,$check3,$capt4,$val4,$check4,$ext = "")
    {
        ...
        $this->b .= "<TD WIDTH=102 CLASS=FORM valign=$valign><INPUT $ext TYPE=CHECKBOX NAME=$name VALUE=$val2 $check2>$capt2</TD>\n";
        $this->b .= "<TD WIDTH=102 CLASS=FORM valign=$valign><INPUT $ext TYPE=CHECKBOX NAME=$name VALUE=$val3 $check3>$capt3</TD>\n";
        $this->b .= "<TD WIDTH=102 CLASS=FORM valign=$valign><INPUT $ext TYPE=CHECKBOX NAME=$name VALUE=$val4 $check4>$capt4</TD>\n";
        $this->b .= "</TR></TABLE><TABLE CELLSPACING=2 CELLPADDING=2>\n\n";
