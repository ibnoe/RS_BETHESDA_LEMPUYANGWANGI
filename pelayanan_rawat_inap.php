...
<table CLASS=TBL_BORDER WIDTH='100%' BORDER=1 CELLSPACING=1 CELLPADDING=2>
  ...
  <tr>
    ...
    <td class="TBL_BODY" align="center"><?=$row1["awal_triwulan"] ?></td>
    <td class="TBL_BODY" align="center"><?=$row1["masuk"] ?></td>
    <td class="TBL_BODY" align="center"><?=$row1["keluar_hidup"] ?></td>
    <td class="TBL_BODY" align="center"><?=$row1["kurang_48jam"] ?></td>
    <td class="TBL_BODY" align="center"><?=$row1["lebih_48jam"] ?></td>
    <td class="TBL_BODY" align="center"><?=$row1["jumlah"] ?></td>
    <td class="TBL_BODY" align="center"><?=$row1["lama_dirawat"] ?></td>
    <td class="TBL_BODY" align="center"><?=$row1["akhir_triwulan"] ?></td>
    <td class="TBL_BODY" align="center"><?=$row1["hari_perawatan"] ?></td>
    <td class="TBL_BODY" align="center"><?=$row1["kelas_utama"] ?></td>
    <td class="TBL_BODY" align="center"><?=$row1["kelas_satu"] ?></td>
    <td class="TBL_BODY" align="center"><?=$row1["kelas_dua"] ?></td>
    <td class="TBL_BODY" align="center"><?=$row1["kelas_tiga"] ?></td>
    <td class="TBL_BODY" align="center"><?=$row1["tanpa_kelas"] ?></td>
  </tr>
  <?
