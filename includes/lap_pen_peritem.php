...
require_once("lib/functions.php");
	...
	title_excel("lap_pen_peritem&tanggal1D=".$_GET["tanggal1D"]."&tanggal1M=".$_GET["tanggal1M"]."&tanggal1Y=".$_GET["tanggal1Y"]."&tanggal2D=".$_GET["tanggal2D"]."&tanggal2M=".$_GET["tanggal2M"]."&tanggal2Y=".$_GET["tanggal2Y"]."&supplier=".$_GET["supplier"]."&faktur_po=".$_GET["faktur_po"]."");
	...
	if (!$GLOBALS['print']) {
		...
		$f->selectSQL("pabrik","PABRIK","SELECT '' AS tc, '' AS tdesc UNION SELECT tc, tdesc FROM rs00001 where tt='PPL' ORDER BY tdesc ASC", $_GET['pabrik'],null);
    ...
    //$t = new PgTable($con, "100%");
      if($_GET['supplier']){
		...
		$cond = " AND d.prinsiple_id='".$_GET['pabrik']."'";
	...
	$cond = " AND d.prinsiple_id='".$_GET['pabrik']."' AND supp_id='".$_GET['supplier']."' AND (a.po_id LIKE '%".$_GET['faktur_po']."%' OR b.no_faktur LIKE '%".$_GET['faktur_po']."%')";
	}else{}
	
	
 $rowsObat = pg_query($con,"	select a.po_id,b.no_faktur,
to_char(a.po_tanggal,'DD Mon YYYY') as po_tanggal,
a.nama, d.obat, b.item_qty*b.jumlah2 as total_jumlah, b.harga_beli as harga, b.diskon1,b.ppn,b.materai,b.harga_beli * (b.diskon1/100)  as diskon,
((b.item_qty*b.jumlah2)*b.harga_beli)-b.harga_beli * (b.diskon1/100) total,
(((b.item_qty*b.jumlah2)*b.harga_beli)-b.harga_beli * (b.diskon1/100)) * (b.ppn/100)  as ppn2,
((((b.item_qty*b.jumlah2)*b.harga_beli)-b.harga_beli * (b.diskon1/100))+((((b.item_qty*b.jumlah2)*b.harga_beli)-b.harga_beli * (b.diskon1/100)) * (b.ppn/100)))+materai as totalppn
 from rsv_pengadaan a
LEFT JOIN c_po_item_terima b ON b.po_id=a.po_id
...
<table id="list-pasien" width="100%">
    <thead>
        <tr>
            ...
            <td align="CENTER" class="TBL_HEAD" width="60">NO. FAKTUR</td>
    ...
    <tbody>
        <?php
            if(!empty($rowsObat)){
                 ...
                 while($row=pg_fetch_array($rowsObat)){
					 ...
					 if ($oldNoFak == $row['no_faktur'] && $oldNoFak != '') {
						$newNoFak = '';
					 }
        ...
        <tr>
            ...
            <td align="left">&nbsp;&nbsp;&nbsp;<?php echo $newNoFak;?></td>
            <td align="left">&nbsp;&nbsp;&nbsp;<?php echo $newNama;?></td>
            <td align="left">&nbsp;&nbsp;&nbsp;<?php echo $row['obat'];?></td>
            <td align="right"><?php echo $row['total_jumlah'];?>&nbsp;&nbsp;&nbsp;</td>
        ...
        <?php
			...
			?>
         <tr>
	        <td colspan="7" class="TBL_HEAD" align="right">T O T A L</td>
