...
if(strlen($_GET["e"]) > 0) {
    ...
    title("<img src='icon/informasi-2.gif' align='absmiddle' >  MASTER AKUN");
    if (isset($_GET["e"])) {
        $ext = "DISABLED";
    } else {
    ...
    $f->selectSQL("mOBT", "Klasifikasi Akun",
        //"select '' as tc, '' as tdesc union " .
        "select tc, tdesc ".
        "from rs00001 ".
        "where tt = 'AKN' and tc != '000' ".
...
********/
    ...
    $t->ColHeader = array("KODE", "NAMA AKUN", "SUB KLASIFIKASI", "KLASIFIKASI","KETERANGAN","E d i t");
