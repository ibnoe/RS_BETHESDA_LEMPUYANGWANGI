...
*/
    ...
    // search box
    if (!$GLOBALS['print']){
    	title_print("<img src='icon/keuangan-2.gif' align='absmiddle' > Buku Kas Umum");
		title_excel("tracing_data");
    } else {
    	title("<img src='icon/keuangan.gif' align='absmiddle' > Buku Kas Umum");
    }
    echo "<br>";
