...
if($_GET["tc"] == "view") {
    ...
    //------------------------------------------------------- mulai
    if (!$GLOBALS['print']){
    	title("<img src='icon/indikator.gif' align='absmiddle' > TOI");
    } else {
    	title("<img src='icon/indikator.gif' align='absmiddle' > TOI");
    }
   ...
   if (!empty($_GET[mPASIEN])) {
    ...
    echo "<tr>";
    echo "<td>".$spasi1."<b><font size=4>Turn Over Interval</size></b></td>";
    echo "<td>&nbsp;</td>";
    echo "<td align=right>&nbsp;:&nbsp;</td>";
    echo "<td align=right colspan=2><font size=4><b>".number_format($toi,0,",",".")."</b><b> hari</b></size></td>";
    echo "</tr>";
    ...
    echo "&nbsp";
    echo "</table>";
    echo "<b><font size=1>TOI adalah rata-rata hari dimana tempat tidur tidak ditempati dari telah diisi ke saat terisi berikutnya.</size></b>";
    echo "<table cellpadding=0 cellspacing=0 border=0>";
    echo "&nbsp";
    echo "</table>";
    echo "<b><font size=1>Indikator ini memberikan gambaran tingkat efisiensi penggunaan tempat tidur.</size></b>";
    echo "<table cellpadding=0 cellspacing=0 border=0>";
    echo "&nbsp";
    echo "</table>";
    echo "<b><font size=1>Idealnya tempat tidur kosong tidak terisi pada kisaran 1-3 hari.</size></b>";
