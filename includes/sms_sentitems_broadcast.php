...
// 24-12-2006
  ...
  echo "<table>";
    echo "<tr>";
    echo "<td><img src='icon/cellphone_icon.gif' align='absmiddle' ><b><font size=4>SMS Broadcast</size></b></td>";
    echo "</tr>";
    echo "</table>";

    if(!$GLOBALS['print']){
        sms_index("sms_index_broadcast");
        sms_outbox("sms_schedule");
        }else {
	}

$t = new PgTable($con, "100%");

$t->SQL = "SELECT SendingDateTime,DestinationNumber,TextDecoded FROM sms_log";
