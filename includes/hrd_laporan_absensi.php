...
require_once("lib/functions.php");
    // search box
    //title("<img src='icon/informasi-2.gif' align='absmiddle' > LAPORAN ABSENSI PEGAWAI");
	title_excel("hrd_laporan_absensi&tanggal1D=".$_GET["tanggal1D"]."&tanggal1M=".$_GET["tanggal1M"]."&tanggal1Y=".$_GET["tanggal1Y"]."&tanggal2D=".$_GET["tanggal2D"]."&tanggal2M=".$_GET["tanggal2M"]."&tanggal2Y=".$_GET["tanggal2Y"]."");
    if (!$GLOBALS['print']){
		title_print("<img src='icon/informasi-2.gif' align='absmiddle' > LAPORAN ABSENSI PEGAWAI");
    ...
    $t->SQL =
		...
		"     when b.tempat_bangsal != '' and b.tempat_poli = '' then d.bangsal ".
	        ...
	        "left outer join rs00001 c ON b.tempat_poli = c.tc and c.tt='LYN' ".
                ...
                " group by a.nip,a.nama, e.shift, b.tempat_bangsal, b.tempat_poli,c.tdesc, b.tempat, b.tanggal, e.jm_mulai, e.jm_selesai, b.status, g.status, f.status,d.bangsal ";
    ...
    //$t->setlocale("id_ID");
    $t->ColHeader = array("NRP/NIP","NAMA", "SHIFT","TEMPAT","TANGGAL","MULAI","SELESAI", "KET" );
