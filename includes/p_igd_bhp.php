...
title_print("<img src='icon/apotek1-icon.png' align='absmiddle' width=48 >  LAYANAN BHP PASIEN IGD / OK");
$ext = "OnChange = 'Form1.submit();'";
    ...
    $SQLSTR = "select a.mr_no,a.id,upper(a.nama)as nama,a.alm_tetap,a.kesatuan,a.tdesc,a.statusbayar ".
            "from rsv_pasien4 a ".
            "WHERE a.poli='100' ";
...
if ($_GET["search"]) {
    $SQLWHERE = "and (upper(a.nama) LIKE '%".strtoupper($_GET["search"])."%' or a.id like '%".$_GET['search']."%' or a.mr_no like '%".$_GET["search"]."%' ".
                ...
                group by a.mr_no,a.id,a.nama,a.alm_tetap,a.kesatuan,a.tdesc,a.statusbayar ";
}
if (!isset($_GET[sort])) {
   $_GET[sort] = "a.id";
   $_GET[order] = "asc";
...
$t->ColFormatHtml[2] = "<A CLASS=SUB_MENU1 HREF='$SC?p=apotik_bhp_igd&rg=<#1#>'><#2#></A>";
$t->execute();
?>