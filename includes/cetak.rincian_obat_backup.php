...
<HTML>
    ...
    /*$rt = pg_query($con,
            "select id as code, mr_no, tanggal_reg, waktu_reg, nama, tlp_tetap, alm_tetap, kota_tetap, diagnosa_sementara from rsv_pasien2 where id::= '$reg'  ");
...
-->
<table width="50%" border="0" cellpadding="0" cellspacing="0" style="font-family: Tahoma; font-size: 14px; letter-spacing: 2px;">
		<tr valign="middle" >
...
<table width="50%" border="0" cellpadding="0" cellspacing="0" style="font-family: Tahoma; font-size: 11px; letter-spacing: 2px;">
    ...
    <tr>
        <td align="center" colspan="6" style="font-family: Tahoma; font-size: 11px; letter-spacing: 3px;"><b>RINCIAN TRANSAKSI FARMASI RAWAT INAP</b></td>
    </tr>
</table>
...
<table width="50%" border="0" cellpadding="0" cellspacing="0" style="font-family: Tahoma; font-size: 11px; letter-spacing: 2px;">
    <tr>
        <!-- <td width="1%" align="left" style='border-top:solid 1px #000;border-bottom:solid 1px #000;'>Waktu Entry</td> -->
...
?>
    <tr>
        <!-- <td class="" align="left" height="15" ><?=tanggal($row["tanggal_entry"]). ' &nbsp; ' .$arrJamEntry[0].':'.$arrJamEntry[1]?></td> -->
...
<table width="50%" border="0" cellpadding="0" cellspacing="0" style="font-family: Tahoma; font-size: 11px; letter-spacing: 2px;">
    ...
    <tr>
        ...
        <td width="15%" colspan="2" align="center" class="TITLE_SIM3" style="font-family: Tahoma; font-size: 11px; letter-spacing: 2px;"><? echo "Boyolali, ".$tgl_now."<br>".$_SESSION["nama_usr"]; ?></td>
    </tr>
    <tr>    
        <td width="50%" colspan="6" align="left" class="TITLE_SIM3">&nbsp;</td>
    </tr>
