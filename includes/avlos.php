...
if($_GET["tc"] == "view") {
    ...
    //------------------------------------------------------- mulai
    if (!$GLOBALS['print']){
    	title("<img src='icon/indikator.gif' align='absmiddle' > AVLOS");
    } else {
    	title("<img src='icon/indikator.gif' align='absmiddle' > AVLOS");
    }
   ...
   if (!empty($_GET[mPASIEN])) {
    ...
    // end of 24-12-2006
    echo "<tr>";
    echo "<td>".$spasi1."<b><font size=4>Average Length of Stay</size></b></td>";
    echo "<td>&nbsp;</td>";
    echo "<td align=right>&nbsp;:&nbsp;</td>";
    echo "<td align=right colspan=2><font size=4><b>".number_format($avlos,0,",",".")."</b><b> hari</b></size></td>";
    echo "</tr>";
    ...
    echo "&nbsp";
    echo "</table>";
    echo "<b><font size=1>AVLOS adalah rata-rata lama rawat seorang pasien.</size></b>";
    echo "<table cellpadding=0 cellspacing=0 border=0>";
    echo "&nbsp";
    echo "</table>";
    echo "<b><font size=1>Indikator ini disamping memberikan gambaran tingkat efisiensi, juga dapat memberikan gambaran mutu pelayanan, apabila diterapkan pada diagnosis tertentu dapat dijadikan hal yang perlu pengamatan yang lebih lanjut.</size></b>";
    echo "<table cellpadding=0 cellspacing=0 border=0>";
    echo "&nbsp";
    echo "</table>";
    echo "<b><font size=1>Secara umum nilai AVLOS yang ideal antara 6-9 hari (Depkes, 2005).</size></b>";
