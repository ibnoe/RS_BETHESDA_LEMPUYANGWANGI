...
if($_GET["tc"] == "view") {
    ...
    $t->ColHeader = array("NO.RM","NO.REG","NAMA","PANGKAT","NRP/NIP","NAMA OBAT","HARGA SATUAN","QTY","TOTAL (Rp.)");
    ...
    // search box
    title("<img src='icon/keuangan-2.gif' align='absmiddle' > LAPORAN PENDAPATAN OBAT (FARMASI)");
	title_excel("lap_pend_obat&tanggal1D=".$_GET["tanggal1D"]."&tanggal1M=".$_GET["tanggal1M"]."&tanggal1Y=".$_GET["tanggal1Y"]."&tanggal2D=".$_GET["tanggal2D"]."&tanggal2M=".$_GET["tanggal2M"]."&tanggal2Y=".$_GET["tanggal2Y"]."&mUNIT=".$_GET["mUNIT"]."&mPASIEN=".$_GET["mPasien"]."");
