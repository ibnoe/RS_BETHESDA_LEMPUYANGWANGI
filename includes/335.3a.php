...
<form name="form1" method="post" action="<?php echo $PHP_SELF."?p=335&t1=&kas=".$_GET['kas']."&rg=".$_GET['rg']."&sub=3"; ?>">
    <table width="100%">
        ...
        if ($rec > 0) {
            $sqla = "select distinct a.is_bayar,a.id,to_char(a.tanggal_trans,'dd-mm-yyyy') as tanggal_trans, to_char(a.waktu_entry, 'HH:MI:SS') as waktu_entry, a.no_reg,b.id, 
...
where a.referensi ='P' and no_reg='$reg' order by a.id ";
		    ...
		    $tglTrans = $row1["tanggal_trans"];
                    ...
                    $totalPenjamin = $totalPenjamin + $row_penjamin1['dibayar_penjamin'];
                    ?>
                    ...
                    <tr>
                        ...
                        ?>
                        <td class="TBL_BODY" align="right"><b><?= number_format($tagihan1,
                                2,
                                ",",
                                ".") ?></b></td>
                        <?php
                        if (isset($_POST['edit_' . $z])) {
                            ...
                            echo "<td class='TBL_BODY'  align='center'><input type='checkbox' name='ck_penjamin";
                            echo $z;
                            echo"' id='ck_penjamin";
                            echo $z;
                        ...
                        ".") ?></b></td>
                            ...
                            echo "<td class='TBL_BODY'  align='right'><b>";
                            echo number_format($penjamin1,
                                    2,
                                    ',',
                                    '.');
                            echo "</b></td>";
                        ...
                        ".") ?></b></td>
                <?
                echo "<td class='TBL_BODY'  align='center'><input type='submit' name='edit_";
                echo $z;
                echo"' id='edit_";
                echo $z;
                echo "' value='EDIT' style='visibility:visible'>";
                echo "</td>";
            } else {
                $jumlah_bayar1[$index_total1] = $tagihan1;
                echo "<td class='TBL_BODY'  align='center'><input type='checkbox' name='ck_penjamin";
