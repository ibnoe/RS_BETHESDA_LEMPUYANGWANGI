...
if (!$GLOBALS['print']){
    ...
    title_excel("".$_GET["p"]."&tgl_dari=".$_GET["tgl_dari"]."&tgl_sampai=".$_GET["tgl_sampai"]."&tipe_pasien_id=".$_GET["tipe_pasien_id"]."&unit_id=".$_GET["unit_id"]."");
} else {
...
$(document).ready(function() { 
	...
	$("#btn_filter").click(function(){
		...
		window.location = 'index2.php?p=lap_pendapatan_rwj&tgl_dari='+tglDari+'&tgl_sampai='+tglSampai+'&tipe_pasien_id='+tipePasienId+'&unit_id='+unitId;
