            ...
            <tr>
                ...
                <td>
                    <select name="dokter" id="dokter">
                        <option value=""></option>
                        <?php 
                            while($rowDokter = pg_fetch_array($rowsDokter)){
                                echo '<option value="'.$rowDokter["dokter"].'"';
                                        if($_GET['dokter'] == $rowDokter['dokter']){
                                            echo 'selected="selected"';
                                        }
                                echo '">'.$rowDokter["dokter"].'</option>';
                            }
                        ?>
                        <option value=""></option>
                    </select>                    
...
<div align="right"><a href="includes/lap_pendapatan_rwj_xls.php?tgl_dari=<?php echo $tglDari?>&tgl_sampai=<?php echo $tglSampai?>&tipe_pasien_id=<?php echo $_GET['tipe_pasien_id'] ?>&unit_id=<?php echo $_GET['unit_id']?>&dokter=<?php echo $_GET['dokter']?>" ><img src="icon/Excel-22.gif" width="24" /> &nbsp;&nbsp; [ Download ]</a> &nbsp;&nbsp;&nbsp;</div>
...
<table id="list-pasien" width="100%">
        <tr>
            ...
            <td rowspan="2" class="TBL_HEAD" align="center" width="15%">DOKTER</td>
            <td colspan="13" class="TBL_HEAD" align="center">RINCIAN TAGIHAN</td>
            <td rowspan="2" class="TBL_HEAD" align="center" width="7%">TOTAL TAGIHAN</td>
            <td colspan="8" class="TBL_HEAD" align="center">PEMBAYARAN</td>
        </tr>
        <tr>
            <?php
    ...
    ?>
            ...
            " ",
            ".") ?> </td>
            <td class="TBL_BODY" align="right" id="val_tagihan_<?php echo $i ?>"><?php echo number_format($totalPembayaran,
            0,
            " ",
            ".") ?> </td>
            ...
            " ",
            ".") ?> </td>
            <td class="TBL_BODY" align="right" id="val_sisa_<?php echo $i ?>"><?php echo number_format(($totalPembayaran) - $totalPembayaran,
            0,
            " ",
            ".") ?> </td>
            </tr>
    ...
    <tr>
        ...
        <td class="TBL_HEAD" align="right" id="jumlah_bhp">0</td>
...
$(document).ready(function() { 
	...
	$("#btn_filter").click(function(){
		...
		window.location = 'index2.php?p=lap_pendapatan_rwj&tgl_dari='+tglDari+'&tgl_sampai='+tglSampai+'&tipe_pasien_id='+tipePasienId+'&unit_id='+unitId+'&dokter='+dokter;
