...
//akhiran no kwitansi
  ...
  is_bayar, user_id, cab, bayar, no_kartu, waktu_bayar, no_kwitansi, pembulatan, total_pembulatan) " .
                        " values(nextval('kasir_seq'),'" . $_GET[rg] . "',CURRENT_DATE, " .
                        "'BYD','N','N',0,$_GET[bayar1],'Y','" . $_SESSION["uid"] . "','" . $_GET[mCAB] . "','" . $_GET[f_bayar] . "','" . $_GET[f_no_kartu] . "',CURRENT_TIME,'$no_kwitansi','" . $_GET[pembulatan1] . "','" . $_GET[total_pembulatan1] . "')");
            } else {
                pg_query("insert into rs00005 (id, reg, tgl_entry, kasir, is_obat, is_karcis, layanan, jumlah,
  is_bayar, user_id, cab, bayar, no_kartu, waktu_bayar, no_kwitansi, pembulatan, total_pembulatan) " .
                        " values(nextval('kasir_seq'),'" . $_GET[rg] . "',CURRENT_DATE, " .
                        "'BYD','N','N',0,$_GET[bayar],'Y','" . $_SESSION["uid"] . "','" . $_GET[mCAB] . "','" . $_GET[f_bayar] . "','" . $_GET[f_no_kartu] . "',CURRENT_TIME,'$no_kwitansi','" . $_GET[pembulatan] . "','" . $_GET[total_pembulatan] . "')");
            }
            ...
            if ($_GET[bayar1] < $_GET[bayar]) {
                pg_query("insert into rs00005 (id, reg, tgl_entry, kasir, is_obat, is_karcis, layanan, jumlah,
		is_bayar, user_id, cab, bayar, no_kartu, waktu_bayar, no_kwitansi, pembulatan, total_pembulatan) values
		(nextval('kasir_seq'),'" . $_GET[rg] . "',CURRENT_DATE, 'BYR','N','N',0,$_GET[bayar1],'Y','" . $_SESSION["uid"] . "',
		'" . $_GET[mCAB] . "','" . $_GET[f_bayar] . "','" . $_GET[f_no_kartu] . "',CURRENT_TIME,'$no_kwitansi','" . $_GET[pembulatan1] . "','" . $_GET[total_pembulatan1] . "')");
            } else {
                pg_query("insert into rs00005 (id, reg, tgl_entry, kasir, is_obat, is_karcis, layanan, jumlah,
		is_bayar, user_id, cab, bayar, no_kartu, waktu_bayar, no_kwitansi, pembulatan, total_pembulatan) values
		(nextval('kasir_seq'),'" . $_GET[rg] . "',CURRENT_DATE, 'BYR','N','N',0,$_GET[bayar],'Y','" . $_SESSION["uid"] . "',
		'" . $_GET[mCAB] . "','" . $_GET[f_bayar] . "','" . $_GET[f_no_kartu] . "',CURRENT_TIME,'$no_kwitansi','" . $_GET[pembulatan] . "','" . $_GET[total_pembulatan] . "')");
            }
            $sql1 = ("update rs00006 set is_bayar = 'Y' where id = '" . $_GET[rg] . "'");
            $sql5 = ("update rs00005 set is_bayar = 'Y' where reg = '" . $_GET[rg] . "'");
            $sql6 = ("update rs00008 set is_bayar = 'Y' where no_reg = '" . $_GET[rg] . "'");
  ...
  is_bayar, user_id, cab, bayar, no_kartu, waktu_bayar, no_kwitansi, pembulatan, total_pembulatan) " .
                        " values(nextval('kasir_seq'),'" . $_GET[rg] . "',CURRENT_DATE, " .
                        "'BYI','N','N',0,$_GET[bayar1],'Y','" . $_SESSION["uid"] . "','" . $_GET[mCAB] . "','" . $_GET[f_bayar] . "','" . $_GET[f_no_kartu] . "',CURRENT_TIME,'$no_kwitansi','" . $_GET[pembulatan1] . "','" . $_GET[total_pembulatan1] . "')");
            } else {
                pg_query("insert into rs00005 (id, reg, tgl_entry, kasir, is_obat, is_karcis, layanan, jumlah,
  is_bayar, user_id, cab, bayar, no_kartu, waktu_bayar, no_kwitansi, pembulatan, total_pembulatan) " .
                        " values(nextval('kasir_seq'),'" . $_GET[rg] . "',CURRENT_DATE, " .
                        "'BYI','N','N',0,$_GET[bayar],'Y','" . $_SESSION["uid"] . "','" . $_GET[mCAB] . "','" . $_GET[f_bayar] . "','" . $_GET[f_no_kartu] . "',CURRENT_TIME,'$no_kwitansi','" . $_GET[pembulatan] . "','" . $_GET[total_pembulatan] . "')");
            }
            $sql1 = ("update rs00006 set is_bayar = 'Y' where id = '" . $_GET[rg] . "'");
            $sql5 = ("update rs00005 set is_bayar = 'Y' where reg = '" . $_GET[rg] . "'");
            $sql6 = ("update rs00008 set is_bayar = 'Y' where no_reg = '" . $_GET[rg] . "'");
...
########################################################################################efrizal
    ...
    echo "    sWin = window.open('includes/cetak.rincian_penjamin.php?p=cetak.rincian&rg=' + tag+'&kas=" . $_GET["kas"] . "', 'xWin'," .
    " 'top=0,left=0,width=750,height=550,menubar=no,scrollbars=yes');\n";
    echo "    sWin.focus();\n";
    echo "}\n";
    echo "</script>\n";
    ...
    echo "    sWin = window.open('includes/cetak.rincian.php?p=cetak.rincian&rg=' + tag+'&kas=" . $_GET["kas"] . "', 'xWin'," .
    " 'top=0,left=0,width=750,height=550,menubar=no,scrollbars=yes');\n";
    echo "    sWin.focus();\n";
    echo "}\n";
    echo "</script>\n";
