...
title("<img src='icon/rawat-jalan-2.gif' align='absmiddle' >Layanan Apotik Rawat Jalan");
echo "<br>";
...
if ($reg > 0) {
 ...
 //   echo "<input name=b3 type=button value='Resep / Obat' onClick='window.location=\"$SC?p=$PID&rg=".$_GET["rg"]."&sub=obat\";'>&nbsp;";
    ...
    if ($AKSES == "ri" || $AKSES == "rj" || $_SESSION[uid] == "root" || $_SESSION[uid] == "rumahsakit") {
    	echo "<input name=b3 type=button value='Resep / Obat' onClick='window.location=\"$SC?p=$PID&rg=".$_GET["rg"]."&sub=obat\";'>&nbsp;";
    }  
...
//awalnya $_SESSION [gr]
    if ($_SESSION[uid] == "apotik" || $_SESSION[uid] == "apotikrj" || $_SESSION[uid] == "root" || $_SESSION[uid] == "rumahsakit" || $_SESSION[gr] == "APOTKRJ") {
       $tambah = "&sub=obat";
