...
if (!$GLOBALS['print']){
    ...
    title_excel("lap_per_shift&tanggal1D=".$_GET["tanggal1D"]."&tanggal1M=".$_GET["tanggal1M"]."&tanggal1Y=".$_GET["tanggal1Y"]."".
...
$rRacikan = pg_query($con,
          ...
          "     ".$addParam." and (b.waktu_reg between '07:00' and '14:00') ");
...
$rowsObatTotal = pg_query($con,
          ...
          "sum((a.tagihan)+(a.referensi::numeric)) as jum ".
          "from rs00008 a ".
          "     left join rs00006 b ON a.no_reg = b.id ".
          "     left join rs00001 d ON (b.tipe = d.tc and d.tt = 'JEP') ".
          "     left join rs00016 f ON a.item_id = f.obat_id::character varying ".
...
$rowsObat = pg_query($con, "select a.tanggal_trans as tgl, a.nmr_transaksi as nmr_transaksi, a.no_reg as no_reg, c.mr_no as mr_no, c.nama as nama, ".
          "     e.obat as obat, a.qty as qty, f.harga::integer*a.qty as harga_pokok, ".
          ...
          "		CASE WHEN e.kategori_id::numeric=020 THEN (a.qty * 100)
		       	...
		       	END as harga_tuslah, ".
          "		sum((a.tagihan)+(a.referensi::numeric)) as harga_total ".
          "from rs00008 a ".
          "     left join rs00006 b ON a.no_reg = b.id ".
...
$rowsTotalTuslahObats = pg_query($con, "select sum(a.harga) as jual, ".
          ...
          "where (a.tanggal_trans between '$ts_check_in1' and '$ts_check_in2') and ".
          "     (a.trans_type::text = 'OB1'::text OR a.trans_type::text = 'RCK'::text) ".
          "     ".$addParam." and (b.waktu_reg between '07:00' and '14:00') group by a.nmr_transaksi order by a.nmr_transaksi ");
...
<table id="list-pasien" width="100%">
    ...
    <tbody>
        ...
        <?php
			...
			$jumObat= getfromtable("select COUNT(e.obat) as obat ".
          "from rs00008 a ".
          "     left join rs00006 b ON a.no_reg = b.id ".
          "     left join rs00002 c ON b.mr_no = c.mr_no ".
          "     left join rs00001 d ON (b.tipe = d.tc and d.tt = 'JEP') ".
        ...
        ?>
        <tr>
	        <td colspan="6" class="TBL_HEAD" align="right">Jumlah Obat</td>
	        <td class="TBL_HEAD" align="left" id="jum_obat">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $jumObat;?>&nbsp;&nbsp;&nbsp;Jenis</td>
	        <td colspan="3" class="TBL_HEAD" align="right">T O T A L</td>
...
$rRacikan = pg_query($con,
          ...
          "where (a.tanggal_trans between '$ts_check_in1' and '$ts_check_in2') and ".
          "     (a.trans_type::text = 'OB1'::text OR a.trans_type::text = 'RCK'::text) ".
          "     ".$addParam." and (b.waktu_reg between '14:01' and '20:00') ");
...
$rowsTotalTuslahObats = pg_query($con, "select sum(a.harga) as jual, ".
          ...
          "where (a.tanggal_trans between '$ts_check_in1' and '$ts_check_in2') and ".
          "     (a.trans_type::text = 'OB1'::text OR a.trans_type::text = 'RCK'::text) ".
          "     ".$addParam." and (b.waktu_reg between '14:01' and '20:00') group by a.nmr_transaksi order by a.nmr_transaksi ");
...
$rRacikan = pg_query($con,
          ...
          "where (a.tanggal_trans between '$ts_check_in1' and '$ts_check_in2') and ".
          "     (a.trans_type::text = 'OB1'::text OR a.trans_type::text = 'RCK'::text) ".
          "     ".$addParam." and (b.waktu_reg between '20:01' and '23:59') ");
...
$rowsTotalTuslahObats = pg_query($con, "select sum(a.harga) as jual, ".
          ...
          "where (a.tanggal_trans between '$ts_check_in1' and '$ts_check_in2') and ".
          "     (a.trans_type::text = 'OB1'::text OR a.trans_type::text = 'RCK'::text) ".
          "     ".$addParam." and (b.waktu_reg between '20:01' and '23:59') group by a.nmr_transaksi order by a.nmr_transaksi ");
...
?>
<BR><BR>
<B>SHIFT 3 MALAM A (20:00 - 23:59)</B>
<table id="list-pasien" width="100%">
    <thead>
        <tr>
            <td align="CENTER" class="TBL_HEAD" width="20">No.</td>
...
$rRacikan = pg_query($con,
          ...
          "where (a.tanggal_trans between '$ts_check_in1' and '$ts_check_in2') and ".
          "     (a.trans_type::text = 'OB1'::text OR a.trans_type::text = 'RCK'::text) ".
          "     ".$addParam." and (b.waktu_reg between '00:01' and '06:59') ");
...
$rowsTotalTuslahObats = pg_query($con, "select sum(a.harga) as jual, ".
          ...
          "where (a.tanggal_trans between '$ts_check_in1' and '$ts_check_in2') and ".
          "     (a.trans_type::text = 'OB1'::text OR a.trans_type::text = 'RCK'::text) ".
          "     ".$addParam." and (b.waktu_reg between '00:01' and '06:59') group by a.nmr_transaksi order by a.nmr_transaksi ");
