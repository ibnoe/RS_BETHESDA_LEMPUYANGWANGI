...
if ($_GET['act'] ==  "detail"){
		if (!$GLOBALS['print']){
			title_print("<img src='icon/medical-record-2.gif' align='absmiddle' > REKAM MEDIS KLINIK BEDAH");
			echo "<DIV ALIGN=RIGHT OnClick='window.history.back()'>".icon("back","Kembali")."</a></DIV>";
		}else{
			title_print("<img src='icon/medical-record.gif' align='absmiddle' > REKAM MEDIS KLINIK BEDAH");
		}
		    //echo "<br>";
			/* - edited 110210 -
			   - Mengganti type data a.id_dokter menjadi character varying
		     */
			$sql = "select a.*,b.nama 
		    		from c_visit a
		...
		echo "</td></tr></table>"; 
		/* - edited 110210 -
		- merubah include file ke rm_tindakan.php
		*/
