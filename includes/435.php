...
*/
    ...
    $f->selectSQL("mUNIT", "Jenis Sumber Pendapatan",
        "select '' as tc, '' as tdesc union ".
        "select tc, tdesc ".
        "from rs00001 ".
    ...
    if (strlen($_GET["search"]) > 0) {
        ...
        $r2 = pg_query($con,
            ...
            "b.sumber_pendapatan_id= '".$_GET["mUNIT"]."' and ".
    ...
    */
    ...
    $t->ColHeader = array("NO.REG","NAMA PASIEN",
                          "TANGGAL","U N I T","LAYANAN/TINDAKAN","TAGIHAN");
