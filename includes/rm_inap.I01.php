...
$_GET["mPOLI"]=$setting_ri["pengawasan_pasien_dewasa"];
	...
	if ($_GET['act'] ==  "detail"){
			...
			$SQL3 = "select to_char(a.tanggal_reg,'dd MM YYYY HH:MM')as tgl_periksa ,a.vis_1,a.vis_2,a.vis_3,a.vis_4,a.vis_5, ".
					" a.vis_6,a.vis_7,a.vis_8,a.vis_9,a.vis_10,a.vis_11,a.vis_12,a.vis_13,a.vis_14,b.nama ".
					"from c_visit_ri a ".
					"LEFT JOIN RS00017 b ON CAST (A.VIS_15 AS INTEGER) = b.ID ".
		...
		?>			
			...
			<tr class="TBL_HEAD">     	
				<td class="TBL_HEAD" width="12%" align="center" rowspan="2">Tanggal <br>& Jam</td>
				<td class="TBL_HEAD" align="center" colspan="7">Observasi</td>
				<td class="TBL_HEAD" align="center" colspan="7">Keseimbangan Cairan</td>
				<td class="TBL_HEAD" align="center" rowspan="2">Perawat</td>
				
			</tr>
			<tr class="TBL_HEAD">
				<td class="TBL_HEAD" align="center">Kesa<br>daran</td>
				<td class="TBL_HEAD" align="center">Tensi</td>	
				<td class="TBL_HEAD" align="center">Nadi</td>	
				<td class="TBL_HEAD" align="center">Perna<br>fasan</td>
				<td class="TBL_HEAD" align="center">Suhu</td>
				<td class="TBL_HEAD" align="center">CVP</td>
				<td class="TBL_HEAD" align="center">Obat</td>
				<td class="TBL_HEAD" align="center">Oral</td>
				<td class="TBL_HEAD" align="center">Infus</td>
				<td class="TBL_HEAD" align="center">Jumlah</td>
				<td class="TBL_HEAD" align="center">Urin</td>
				<td class="TBL_HEAD" align="center">Muntah</td>
				<td class="TBL_HEAD" align="center">Drai<br>bage</td>
				<td class="TBL_HEAD" align="center">Jumlah</td>
			</tr>	
				...
				if (($j<=$max_row) AND ($i >= $mulai)){
					...
					?>		
				 	<tr valign="top" class="<?=$class_nya?>" >  
			        	<td class="TBL_BODY"><?=$row1["tgl_periksa"] ?> </font></td>
			        	<td class="TBL_BODY"><?=$row1["vis_1"] ?> </font></td>
						...
						<td class="TBL_BODY"><?=$row1["nama"] ?> </font></td>
