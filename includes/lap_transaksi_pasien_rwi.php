...
<h2>Laporan Pembayaran Pasien Rawat Inap</h2>
...
$rowsPasien = pg_query($con, "SELECT rs00006.id AS no_reg, 
                            ...
                            ");
?>
<div align="right"><a href="includes/lap_transaksi_pasien_rwi_xls.php?tgl_dari=<?php echo $tglDari?>&tgl_sampai=<?php echo $tglSampai?>&tipe_pasien_id=<?php echo $_GET['tipe_pasien_id'] ?>&unit_id=<?php echo $_GET['unit_id']?>&status=<?php echo $_GET['status']?>" ><img src="icon/Excel-22.gif" width="24" /> &nbsp;&nbsp; [ Download ]</a> &nbsp;&nbsp;&nbsp;</div>
...
$(document).ready(function() { 
	...
	$("#btn_filter").click(function(){
		...
		window.location = 'index2.php?p=lap_transaksi_pasien_rwi&tgl_dari='+tglDari+'&tgl_sampai='+tglSampai+'&tipe_pasien_id='+tipePasienId+'&unit_id='+unitId+'&status='+status+'&shiftkerja='+shiftId;
