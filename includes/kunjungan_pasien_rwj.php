...
<h2>Laporan Kunjungan Pasien Rawat Jalan</h2>
...
$(document).ready(function() { 
	...
	$("#btn_filter").click(function(){
		...
		window.location = 'index2.php?p=kunjungan_pasien_rwj&tgl_dari='+tglDari+'&tgl_sampai='+tglSampai+'&tipe_pasien_id='+tipePasienId+'&unit_id='+unitId;
