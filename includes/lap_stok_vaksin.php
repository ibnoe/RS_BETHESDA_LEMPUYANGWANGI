...
//--start
if (!$GLOBALS['print']){
    title_print("<img src='icon/keuangan-2.gif' align='absmiddle' > <b>LAPORAN PENJUALAN VAKSIN</b>");
    title_excel("lap_stok_vaksin&tanggal1D=".$_GET["tanggal1D"]."&tanggal1M=".$_GET["tanggal1M"]."&tanggal1Y=".$_GET["tanggal1Y"]."".
...
$t->SQL = "select tanggal(a.tanggal_trans,0)||' '||to_char(waktu_entry,'hh:mi:ss') as tgl, a.nmr_transaksi, a.no_reg, c.nama, c.alm_tetap,b.diagnosa_sementara, e.obat, a.qty,to_char(gg.harga,'999,999,999.99'),to_char(a.qty*gg.harga,'999,999,999.99') as total   ".
          ...
          "     ".$addParam."  AND e.kategori_id='029' ".
