...
if(!$GLOBALS['print']){
    ...
    $f->selectSQL("mOBM", "Relasi Apotik",
        "select '' as tc, '' as tdesc union ".
        "select tc, tdesc ".
        "from rs00001  ".
        "where tt='RAP' and tc != '000' order by tdesc", $_GET["mOBM"],
        $ext);
    ...
    $f->titleme("Relasi Apotik &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: $relasi");
...
$rRacikan = pg_query($con,
          ...
          "     and a.nmr_transaksi= '".$row2[nmr_transaksi]."' ".
