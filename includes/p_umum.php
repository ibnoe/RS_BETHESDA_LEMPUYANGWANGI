...
if (!$GLOBALS['print']){
title_print("<img src='icon/rawat-jalan-2.gif' align='absmiddle' >  POLIKLINIK UMUM");
    }
...
if ($_GET["sub"] == "byr") {
        ...
        echo "<br><br><br>";
        $f = new Form("actions/p_umum.insert.php");
        $f->hidden("rg",$_GET["rg"]);
        $f->hidden("mr",$_GET["mr"]);
		...
		$T->show(0);
	    	...
	    	$n = pg_num_rows($r);		    	
				...
				if ($_GET['act'] == "edit") {
					...
					$f = new Form("actions/p_umum.insert.php", "POST", "NAME=Form2");
					$f->hidden("act","edit");
