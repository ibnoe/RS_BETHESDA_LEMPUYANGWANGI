...
if($_GET["tc"] == "view") {
    ...
    //------------------------------------------------------- mulai
    if (!$GLOBALS['print']){
    	title("<img src='icon/indikator.gif' align='absmiddle' > GDR");
    } else {
    	title("<img src='icon/indikator.gif' align='absmiddle' > GDR");
    }
   ...
   if (!empty($_GET[mPASIEN])) {
    ...
    echo "<tr>";
    echo "<td>".$spasi1."<b><font size=4>Gross Death Rate</size></b></td>";
    echo "<td>&nbsp;</td>";
    ...
    echo "&nbsp";
    echo "</table>";
    echo "<b><font size=1>GDR adalah angka kematian umum untuk setiap 1000 penderita keluar.</size></b>";
