...
if($_GET["tc"] == "view") {
    ...
    //------------------------------------------------------- mulai
    if (!$GLOBALS['print']){
    	title("<img src='icon/indikator.gif' align='absmiddle' > BTO");
    } else {
    	title("<img src='icon/indikator.gif' align='absmiddle' > BTO");
    }
   ...
   if (!empty($_GET[mPASIEN])) {
    ...
    echo "<tr>";
    echo "<td>".$spasi1."<b><font size=4>Bed Turn Over </size></b></td>";
    echo "<td>&nbsp;</td>";
    echo "<td align=right>&nbsp;:&nbsp;</td>";
    echo "<td align=right colspan=2><font size=4><b>".number_format($bto,0,",",".")."</b><b> kali</b></size></td>";
    echo "</tr>";
    ...
    echo "&nbsp";
    echo "</table>";
    echo "<b><font size=1>BTO menurut Depkes RI (2005) adalah frekuensi pemakaian tempat tidur pada satu periode, berapa kali tempat tidur dipakai dalam satu satuan waktu tertentu. </size></b>";
    echo "<table cellpadding=0 cellspacing=0 border=0>";
    echo "&nbsp";
    echo "</table>";
    echo "<b><font size=1>Idealnya dalam satu tahun, satu tempat tidur rata-rata dipakai 40-50 kali.</size></b>";
