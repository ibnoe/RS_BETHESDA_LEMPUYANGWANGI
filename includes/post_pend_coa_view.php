...
//--start
if (!$GLOBALS['print']){
    title_print("<img src='icon/keuangan-2.gif' align='absmiddle' > <b>INFORMASI JURNAL</b>");
    title_excel("post_pend_coa_view");
} else {
    title("<img src='icon/keuangan.gif' align='absmiddle' > Informasi Jurnal");
	title_excel("post_pend_coa_view");
}
...
if ($_GET["unit"] == "RAWAT INAP") {

	$addParam = $addParam." AND rs00006.id = '".$_GET['rg']."' "; //no reg
	...
	$rowsPasien = pg_query($con, "SELECT rs00006.id AS no_reg, 
                            ...
                            WHERE rs00006.status_akhir_pasien = '012' ".$addParam."
...
<?php 
	include ('post_pend_coa_view_detail.php')
?>
