...
<?php
$sql="select tgl_entry,jumlah,waktu_bayar,no_kwitansi,oid from rs00005 where reg ='$reg' and kasir='BYI' and layanan = 'DEPOSIT' and jumlah > 0 ";
@$r1 = pg_query($con,$sql);
	@$n1 = pg_num_rows($r1);
...
echo "    sWin = window.open('cetak.rincian.sementara2.php?oid=' + tag+'&kas=".$_GET["kas"]."&rg=$reg', 'xWin',".
