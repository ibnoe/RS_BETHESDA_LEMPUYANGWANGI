...
<table align=center >
    <tr>
        <td align="center" colspan="4" style="font-family: Times New Roman; font-size: 14px; letter-spacing: 0px; font-weight: bold"><b>RINCIAN PELAYANAN RADIOLOGI</b></u></td>
    </tr>
</table>
<br/>
...
//            $addParams = substr($addParams,0,-2).')';
        ...
        $sql = pg_query($con,"select distinct  f.trans_form,f.id,f.item_id, a.layanan, f.referensi, 
				...
				where f.trans_form = 'p_radiologi' AND f.no_reg = '".$_GET[no_reg]."'  ".$addParams." 
        ...
        echo "<th style='border-top:solid 1px #000;border-bottom:solid 1px #000;'><font size=1 face=Times New Roman>RADIOGRAFER</font></th>";
