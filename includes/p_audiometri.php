...
title_print("<img src='icon/rawat-jalan-2.gif' align='absmiddle' >  LAYANAN AUDIOMETRI");
title_excel("p_audiometri&list=".$_GET['list']."&rg=".$_GET['rg']."&poli=".$_GET['poli']."&mr=".$_GET['mr']."&sub=".$_GET['sub']."&act=".$_GET['act']."&polinya=".$_GET['polinya']."&tblstart=".$_GET['tblstart']."");
echo "</td></tr></table>";
...
if ($_GET["sub"] == "byr") {
        ...
        echo "<br><br><br>";
        $f = new Form("actions/p_audiometri.insert.php");
        $f->hidden("rg",$_GET["rg"]);
        $f->hidden("mr",$_GET["mr"]);
	...
	include ("p_audiometri.konsultasi.php");
    	...
    	$T->show(0);
	    	...
	    	$n = pg_num_rows($r);		    	
				...
				if ($_GET['act'] == "edit"){
						...
						$f = new Form("actions/p_audiometri.insert.php", "POST", "NAME=Form2");
						$f->hidden("act","edit");
