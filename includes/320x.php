...
title("Transaksi Layanan/Tindakan Medis");
echo "<br>";
...
if ($reg > 0) {
	...
	if (getFromTable("select to_number(id,'9999999999') as id ".
        ...
        $reg = 0;
        $msg = "Nomor registrasi tidak dpt. dipergunakan. Pasien tlh. Pulang";
    }
...
if ($reg > 0) {
    $r = pg_query($con,
        ...
        "            ELSE 'IGD' ".
        "        END AS rawatan, ".
        "        age(a.tanggal_reg , e.tgl_lahir ) AS umur, h.tdesc as datang ".
        "FROM rs00006 a ".
