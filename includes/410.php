...
if($_GET["tc"] == "view") {
    title_print("Pendapatan dari Non Obat");
    ...
    $r2 = pg_query($con,
              ...
              "     a.trans_type='LTM' and b.tipe = '".$_GET["u"]."'");

    $d2 = pg_fetch_object($r2);
    pg_free_result($r2);

    $t->SQL = "select c.mr_no, a.no_reg,c.nama,c.pangkat_gol,c.nrp_nip, ".
              "     e.layanan, sum(a.qty * a.harga) as tagih ".
              "from rs00008 a  ".
              "     left join rs00006 b ON a.no_reg = b.id ".
              ...
              "group by c.mr_no, c.nama, c.pangkat_gol, c.nrp_nip, a.no_reg, e.layanan";
    ...
    $t->ColHeader = array("NO.MR","NO.REG","NAMA","PANGKAT","NRP/NIP","NAMA LAYANAN/TINDAKAN","TOTAL HARGA (Rp.)");
    ...
    // search box
    title("LAPORAN PENDAPATAN NON-OBAT");
