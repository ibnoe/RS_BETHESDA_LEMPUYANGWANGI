	...
	$r1 = pg_query($con, "$SQL ");
		...
		if (!$printSubTitleObat) {
			...
			if ($oldDate == $d1->tanggal_trans) {
				...
				echo "<td class=TBL_BODY1>$d1->tanggal_trans</td>";
				$oldDate = $d1->tanggal_trans;
			}
			/*
			if ($oldRef == $d1->trans_group) {
				echo "<td class=TBL_BODY1 align=CENTER>&nbsp;</td>";
			} else {
				echo "<td class=TBL_BODY1 align=CENTER>$d1->trans_group</td>";
...
// ******************* RETUR OBAT
    ...
    while ($d1 = pg_fetch_object($r1)) {
        if (!$printSubTitleObat) {
            ...
            if ($oldDate == $d1->tanggal_trans) {
                ...
                echo "<td class=TBL_BODY1>".date("d-m-Y", pgsql2mktime($d1->tanggal_trans))."</td>";
                $oldDate = $d1->tanggal_trans;
            }
            /*
            if ($oldRef == $d1->trans_group) {
            ...
            */
            echo "<td class=TBL_BODY1 colspan=9><B>RETUR OBAT</B></td>";
            echo "</tr>";
        }
        echo "<tr>";
        if ($oldDate == $d1->tanggal_trans) {
	...
	echo "$d1->obat</td>";
       echo "<td class=TBL_BODY1 width='12%'>".number_format($d1->qty)." $d1->satuan</td>";
        echo "<td class=TBL_BODY1 width='12%' align=right>-".number_format($tagihan,2)."</td>";
        echo "<td class=TBL_BODY1 width='12%' align=right>".number_format($pembayaran,2)."</td>";
        echo "</tr>";
     }
    pg_free_result($r1);
...
if ($d1 = pg_fetch_object($r1)) {
    ...
    if ($oldDate == date("Y-m-d")) {
        ...
        echo "<td class=TBL_BODY1>".date("d-m-Y")."</td>";
        $oldDate = date("Y-m-d");
    }
    //echo "<td class=TBL_BODY1 align=CENTER>$ddd->trans_group</td>";
    echo "<td class=TBL_BODY1 colspan=9><B>AKOMODASI ".
    ...
    echo "<td class=TBL_BODY1>&nbsp;</td>";
    echo "<td class=TBL_BODY1>&nbsp;</td>";
    echo "<td class=TBL_BODY1 colspan=5>$d1->bangsal / $d1->ruangan / ".
         "$d1->bed / $d1->klasifikasi_tarif</td>";
    echo "<td class=TBL_BODY1 width='12%'>".number_format($qty)." HARI</td>";
    echo "<td class=TBL_BODY1 width='12%' align=right>".number_format($harga,2)."</td>";
    echo "<td class=TBL_BODY1 width='12%' align=right>".number_format(0,2)."</td>";
    echo "</tr>";
...
if ($d1 = pg_fetch_object($r1)) {
    ...
    echo "<td class=TBL_BODY1 colspan=5>$d1->bangsal / $d1->ruangan / ".
         "$d1->bed / $d1->klasifikasi_tarif</td>";
    echo "<td class=TBL_BODY1 width='12%'>".number_format($d1->qty)." HARI</td>";
    echo "<td class=TBL_BODY1 width='12%' align=right>".number_format($d1->harga,2)."</td>";
    echo "<td class=TBL_BODY1 width='12%' align=right>".number_format(0,2)."</td>";
    echo "</tr>";
...
while ($dd = pg_fetch_object($rr)) {
	...
	if ($oldDate == $dd->tanggal_trans) {
		...
		echo "<td class=TBL_BODY1>".date("d-m-Y",pgsql2mktime($dd->tanggal_trans))."</td>";
		$oldDate = $dd->tanggal_trans;
	}
	echo "<td class=TBL_BODY1 align=CENTER>$dd->no_kwitansi</td>";
	echo "<td class=TBL_BODY1 colspan=6><B>PEMBAYARAN $dd->referensi</B></td>";
	echo "<td class=TBL_BODY1 width='12%'>&nbsp;</td>";
	echo "<td class=TBL_BODY1 width='12%' align=right>".number_format($dd->tagihan,2)."</td>";
	echo "<td class=TBL_BODY1 width='12%' align=right>".number_format($dd->pembayaran,2)."</td>";
	echo "</tr>";
}
pg_free_result($rr);
*/
...
while ($dd = pg_fetch_object($rr)) {
	...
	//if ($oldDate == $dd->tgl_entry) {
		//echo "<td class=TBL_BODY1>&nbsp;</td>";
	//} else {
		echo "<td class=TBL_BODY1>".date("d-m-Y",pgsql2mktime($dd->tgl_entry))."</td>";
		//$oldDate = $dd->tgl_entry;
	//}
	//echo "<td class=TBL_BODY1 align=CENTER>$dd->id</td>";
	echo "<td class=TBL_BODY1 colspan=6><B>PEMBAYARAN</B></td>";
	echo "<td class=TBL_BODY1 width='12%'>&nbsp;</td>";
	echo "<td class=TBL_BODY1 width='12%' align=right>".number_format($dd->tagihan,2)."</td>";
	echo "<td class=TBL_BODY1 width='12%' align=right>".number_format($dd->jumlah,2)."</td>";
	echo "</tr>";
...
while ($dd = pg_fetch_object($rr)) {
	...
	//echo "<td class=TBL_BODY1 align=CENTER>&nbsp;</td>";
	echo "<td class=TBL_BODY1 colspan=6><B>$what</B></td>";
	echo "<td class=TBL_BODY1 width='12%'>&nbsp;</td>";
	echo "<td class=TBL_BODY1 width='12%' align=right>".number_format($dd->tagihan,2)."</td>";
	echo "<td class=TBL_BODY1 width='12%' align=right>".number_format($dd->jumlah,2)."</td>";
	echo "</tr>";
...
echo "<th class=TBL_HEAD2 align=RIGHT>".number_format($d1->tagihan+$bangsal_sudah_posting+$bangsal_belum_posting+$obat_belum_dibayar+$obat_belum_dibayar1+$potObat-$jml_retur,2)."</th>";
...
echo "<th class=TBL_HEAD2 align=RIGHT>".
     number_format(($d1->tagihan+$bangsal_sudah_posting+$bangsal_belum_posting+$obat_belum_dibayar+$obat_belum_dibayar1+$potObat)-$pembayaran-$jml_retur,2)."</th>";
...
echo "<tr>";
echo "<td class=TBL_BODY1><nobr><b>TOTAL BIAYA BAHAN</b></nobr></td>";
echo "<td class=TBL_BODY1>&nbsp;:&nbsp;</td>";
echo "<td class=TBL_BODY1 align=RIGHT>".number_format($tot_bahan,2)."</td>";
echo "<td class=TBL_BODY1 colspan=7 width=100%>&nbsp;</td>";
echo "</tr>";
echo "<tr>";
echo "<td class=TBL_BODY1><nobr><b>TOTAL BIAYA JASA SARANA</b></nobr></td>";
echo "<td class=TBL_BODY1>&nbsp;:&nbsp;</td>";
echo "<td class=TBL_BODY1 align=RIGHT>".number_format($tot_sarana,2)."</td>";
echo "<td class=TBL_BODY1 colspan=7>&nbsp;</td>";
echo "</tr>";
echo "<tr>";
echo "<td class=TBL_BODY1><nobr><b>TOTAL BIAYA JASA PEMERIKSAAN</b></nobr></td>";
echo "<td class=TBL_BODY1>&nbsp;:&nbsp;</td>";
echo "<td class=TBL_BODY1 align=RIGHT>".number_format($tot_periksa,2)."</td>";
echo "<td class=TBL_BODY1 colspan=7>&nbsp;</td>";
echo "</tr>";
$tot_obat2 = $tot_obat - $jml_retur;
echo "<tr>";
echo "<td class=TBL_BODY1><nobr><b>TOTAL BIAYA OBAT</b></nobr></td>";
echo "<td class=TBL_BODY1>&nbsp;:&nbsp;</td>";
echo "<td class=TBL_BODY1 align=RIGHT>".number_format($tot_obat2,2)."</td>";
echo "<td class=TBL_BODY1 colspan=7>&nbsp;</td>";
echo "</tr>";
...
echo "<table cellpadding=0 cellspacing=0 border=0 width=100%>";
echo "<tr>";
echo "<td class=TBL_BODY1><nobr><img src=\"images/spacer.gif\" width=10 height=1><b>- DINAS</b></nobr></td>";
echo "<td class=TBL_BODY1>&nbsp;:&nbsp;</td>";
echo "<td class=TBL_BODY1 align=RIGHT>".number_format($obatx[1],2)."</td>";
echo "<td class=TBL_BODY1 colspan=7 width=100%>&nbsp;</td>";
echo "</tr>";
echo "<tr>";
echo "<td class=TBL_BODY1><nobr><img src=\"images/spacer.gif\" width=10 height=1><b>- DPHO / ASKES</b></nobr></td>";
echo "<td class=TBL_BODY1>&nbsp;:&nbsp;</td>";
echo "<td class=TBL_BODY1 align=RIGHT>".number_format($obatx[2],2)."</td>";
echo "<td class=TBL_BODY1 colspan=7>&nbsp;</td>";
echo "</tr>";
echo "<tr>";
echo "<td class=TBL_BODY1><nobr><img src=\"images/spacer.gif\" width=10 height=1><b>- KOPERASI</b></nobr></td>";
echo "<td class=TBL_BODY1>&nbsp;:&nbsp;</td>";
echo "<td class=TBL_BODY1 align=RIGHT>".number_format($obatx[3],2)."</td>";
echo "<td class=TBL_BODY1 colspan=7>&nbsp;</td>";
echo "</tr>";
echo "</table>";
...
echo "<tr>";
echo "<td class=TBL_BODY1><nobr><b>TOTAL RETUR OBAT</b></nobr></td>";
echo "<td class=TBL_BODY1>&nbsp;:&nbsp;</td>";
echo "<td class=TBL_BODY1 align=RIGHT>".number_format($jml_retur,2)."</td>";
echo "<td class=TBL_BODY1 colspan=7>&nbsp;</td>";
echo "</tr>";
...
echo "<table cellpadding=0 cellspacing=0 border=0 width=100%>";
echo "<tr>";
echo "<td class=TBL_BODY1><img src=\"images/spacer.gif\" width=10 height=1><nobr><b>- DINAS</b></nobr></td>";
echo "<td class=TBL_BODY1>&nbsp;:&nbsp;</td>";
echo "<td class=TBL_BODY1 align=RIGHT>".number_format($obatr[1],2)."</td>";
echo "<td class=TBL_BODY1 colspan=7 width=100%>&nbsp;</td>";
echo "</tr>";
echo "<tr>";
echo "<td class=TBL_BODY1><nobr><img src=\"images/spacer.gif\" width=10 height=1><b>- DPHO / ASKES</b></nobr></td>";
echo "<td class=TBL_BODY1>&nbsp;:&nbsp;</td>";
echo "<td class=TBL_BODY1 align=RIGHT>".number_format($obatr[2],2)."</td>";
echo "<td class=TBL_BODY1 colspan=7>&nbsp;</td>";
echo "</tr>";
echo "<tr>";
echo "<td class=TBL_BODY1><img src=\"images/spacer.gif\" width=10 height=1><nobr><b>- KOPERASI</b></nobr></td>";
echo "<td class=TBL_BODY1>&nbsp;:&nbsp;</td>";
echo "<td class=TBL_BODY1 align=RIGHT>".number_format($obatr[3],2)."</td>";
echo "<td class=TBL_BODY1 colspan=7>&nbsp;</td>";
echo "</tr>";
echo "</table>";
