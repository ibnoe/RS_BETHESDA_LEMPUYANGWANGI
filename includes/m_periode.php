...
if(strlen($_GET["e"]) > 0) {
    ...
    title("<img src='icon/informasi-2.gif' align='absmiddle' >  MASTER PERIODE");
    if (isset($_GET["e"])) {
        $ext = "DISABLED";
    } else {
...
********/
    ...
    $t->ColHeader = array("KODE", "BULAN PERIODE MULAI", "TAHUN PERIODE MULAI", "BULAN PERIODE AKHIR"," TAHUN PERIODE AKHIR","E d i t");
