  ...
  <tr valign="top">
    <td height="98%" align="center" >	 
	  ...
	  <!-- <tr><td align="center" valign="top"><img src="image/bg/bg.home.jpg" border="0" ></td></tr> -->
          <tr><TD bgcolor="#3a7301" align="center"> <script language="Javascript">d.write(menu.m)/*Menu inserted*/</script></TD></tr> 
	  <tr>
	  	<td>
	     	<!-- Main Application -->
			...
			echo "</tr>";
				echo "<tr>";
				echo "<td width=10% align=center height=70><a href=\"index2.php?p=720\" onMouseOut=MM_swapImgRestore() onMouseOver=MM_swapImage('daftar','','icon/daftar-2.gif',1)><img name=\"daftar\" border=0 src=\"icon/daftar.gif\"></a></td>";															
				echo "<td width=10% align=center height=70><a href=\"index2.php?p=730\" onMouseOut=MM_swapImgRestore() onMouseOver=MM_swapImage('daftar','','icon/daftar-2.gif',1)><img name=\"daftar\" border=0 src=\"icon/rawat-jalan.gif\"></a></td>";
				echo "<td width=10% align=center height=70><a href=\"index2.php?p=740\" onMouseOut=MM_swapImgRestore() onMouseOver=MM_swapImage('daftar','','icon/daftar-2.gif',1)><img name=\"daftar\" border=0 src=\"icon/rawat-inap.gif\"></a></td>";		
				echo "<td width=10% align=center height=70><a href=\"index2.php?p=405\" onMouseOut=MM_swapImgRestore() onMouseOver=MM_swapImage('daftar','','icon/daftar-2.gif',1)><img name=\"daftar\" border=0 src=\"icon/igd.gif\"></a></td>";	
				echo "";	
				echo "</tr>";	
	...
	if ($result) {
		while($ors = pg_fetch_array($result)) {
			...
			//$row = $row +5;
			$strXML .= "<set name='" . $ors[tdesc] . "' value='" . $row . "' />";
	...
	//Create the chart - Pie 3D Chart with data from $strXML
	echo renderChart("FusionCharts/FCF_Line.swf", "", $strXML, "2", 500, 250);
