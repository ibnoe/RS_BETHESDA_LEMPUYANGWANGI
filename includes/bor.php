...
if($_GET["tc"] == "view") {
    ...
    //------------------------------------------------------- mulai
    if (!$GLOBALS['print']){
    	title("<img src='icon/indikator.gif' align='absmiddle' > BOR");
    } else {
    	title("<img src='icon/indikator.gif' align='absmiddle' > BOR");
    }
   ...
   if (!empty($_GET[mPASIEN])) {
    ...
    //echo "<tr>";
    //echo "<td colspan=4><b><font size=1>BOR</size></b></td>";
    ...
    echo "<tr>";
    echo "<td>".$spasi1."<b><font size=4>Bed Occupancy Ratio</size></b></td>";
    echo "<td>&nbsp;</td>";
    echo "<td align=right>&nbsp;:&nbsp;</td>";
    echo "<td align=right rowspan=2><font size=4><b>".number_format($bor,2,",",".")."</b><b> % </b></size></td>";
    echo "</tr>";
    ...
    echo "&nbsp";
    echo "</table>";
    echo "<b><font size=1>BOR adalah prosentase pemakaian tempat tidur pada satuan waktu tertentu.</size></b>";
    echo "<table cellpadding=0 cellspacing=0 border=0>";
    echo "&nbsp";
    echo "</table>";
    echo "<b><font size=1>Indikator ini memberikan gambaran tinggi rendahnya tingkat pemanfaatan tempat tidur rumah sakit. </size></b>";
    echo "<table cellpadding=0 cellspacing=0 border=0>";
    echo "&nbsp";
    echo "</table>";
    echo "<b><font size=1>Nilai parameter BOR yang ideal adalah antara 60-85% (Depkes RI, 2005).</size></b>";
