...
$result = pg_query($con, "SELECT DISTINCT rs00015.id, rs00015.obat, rs00016.harga, rs00016a.qty_029 AS stok
    FROM rs00015 
...
<script>
    $(function() {
        ...
        $('#list_pemakaian_bhp').load('actions/apotik_bhp_ok_insert.php?rg=<?php echo $_GET['rg'] ?>&fs=qty_029');
        ...
        $('#save-obat').click(function(){
            ...
            $.post('actions/apotik_bhp_ok_insert.php?rg=<?php echo $_GET['rg']?>&fs=qty_029',
                        {
                            rg: valRg,
                            obat_id: valObatId,
                            qty: valQty,
    ...
    function delete_data_obat(id){
         ...
         $.post('actions/apotik_bhp_ok_insert.php?rg=<?php echo $_GET['rg']?>&fs=qty_029&del=true',
                        {
                            obat_id: obatId,
                            qty: qty,
                            rs00008_id: id
    ...
    function delete_data_obat_return(id){
         ...
         $.post('actions/apotik_bhp_ok_insert.php?rg='+valRg+'&fs=qty_029&delreturn=true',
                        {
