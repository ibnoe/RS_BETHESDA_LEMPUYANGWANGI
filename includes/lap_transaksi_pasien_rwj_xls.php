...
?>     
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  PERIODE &nbsp;&nbsp;&nbsp;&nbsp; : <?php echo tanggal($tglDari) .' s.d '. tanggal($tglSampai)  ?></td>
 ...
 <tr height=20 style='height:15.0pt'>
  <td colspan=6 height=20 class=xl6932053 style='height:15.0pt'>
  TIPE PASIEN &nbsp;&nbsp;&nbsp;&nbsp; : <?php $query = pg_query($con,"select tdesc from rs00001 where tt='JEP' and tc='".$_GET['tipe_pasien_id']."'");  
  $tipe = pg_fetch_array($query);
  if($_GET['tipe_pasien_id']!=''){
  echo $tipe['tdesc'];
  }else{
  echo "Semua";
...
<?php
				 $totalTagih = $totalTagih+$row['tagihan'];
				 $totalBayar = $totalBayar+$row['bayar'];
				 $totalPenjamin = $totalPenjamin+$row['penjamin'];
                 }
            }
}else{
            if(!empty($rowsPasien)){
...
?>
   <tr>
            <td style="border: .5pt solid black"><?php echo $n?></td>
            <td style="border: .5pt solid black;" align="right">&nbsp;</td>
            <td style="border: .5pt solid black;">&nbsp;</td>
            <td style="border: .5pt solid black;">&nbsp;</td>
            <td style="border: .5pt solid black;">&nbsp;</td>
            <td style="border: .5pt solid black;">TOTAL</td>
            <td style="border: .5pt solid black;" align="right"><?php echo number_format($totalTagih,'0',',','.')?></td>
            <td style="border: .5pt solid black;" align="right"><?php echo number_format($totalBayar,'0',',','.')?></td>
            <td style="border: .5pt solid black;" align="right"><?php echo number_format($totalPenjamin,'0',',','.')?></td>
            <!--td style="border-bottom: solid 1px #000;" align="left"> &nbsp;</td-->
        </tr>
