...
<a href=\"index2.php?p=infopasien\" onmouseout=MM_swapImgRestore() onmouseover=MM_swapImage('Daftar1','','icon/info_pasien_bigbutton2.png',1)><img src=\"icon/info_pasien_bigbutton.png\" name=\"daftar\" width=156 height=61 border=0 id=\"Daftar1\" /></a>
</body></td>";														
		echo "<td width=10% align=center height=70><body onload=MM_preloadImages('icon/info_bangsal_bigbutton2.png')>
<a href=\"index2.php?p=infobangsal\" onmouseout=MM_swapImgRestore() onmouseover=MM_swapImage('Bangsal1','','icon/info_bangsal_bigbutton2.png',1)><img src=\"icon/info_bangsal_bigbutton.png\" name=\"bangsal\" width=156 height=61 border=0 id=\"Bangsal1\" /></a>
</body></td>";	
		echo "<td width=10% align=center height=70><body onload=MM_preloadImages('icon/info_tarif_bigbutton2.png')>
<a href=\"index2.php?p=infotarif\" onmouseout=MM_swapImgRestore() onmouseover=MM_swapImage('Tarif1','','icon/info_tarif_bigbutton2.png',1)><img src=\"icon/info_tarif_bigbutton.png\" name=\"tarif\" width=156 height=61 border=0 id=\"Tarif1\" /></a>
</body></td>";
		echo "<td width=10% align=center height=70><body onload=MM_preloadImages('icon/info_ri_bigbutton2.png')>
<a href=\"index2.php?p=pasien_ri\" onmouseout=MM_swapImgRestore() onmouseover=MM_swapImage('Ri1','','icon/info_ri_bigbutton2.png',1)><img src=\"icon/info_ri_bigbutton.png\" name=\"ri\" width=156 height=61 border=0 id=\"Ri1\" /></a>
</body></td>";
				echo "";	
				echo "</tr>";	
