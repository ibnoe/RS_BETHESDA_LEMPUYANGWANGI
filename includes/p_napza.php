...
title("<img src='icon/rawat-jalan-2.gif' align='absmiddle' >  POLIKLINIK NAPZA");
	    	...
	    	$n = pg_num_rows($r);		    	
				...
				//$f->calendar("tanggal_reg","Tanggal Registrasi",15,15,$d2[1],"Form2","icon/calendar.gif","Pilih Tanggal",$ext);
					...
					if (isset($_SESSION["SELECT_EMP"])) {
						...
						$f->textAndButton3("f_id_dokter","Dokter Pemeriksa",2,10,0,$ext,"nm2",30,70,$d2["nama"],$ext,"...",$ext,"OnClick='selectPegawai();';");echo "&nbsp;  jenis layanan &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;  &nbsp; :&nbsp;<select><option>regular</option><option>therapy comunity</option><option>detoksifikasi</option></select>";
					}
					...
					while ($i<= $max) {		
						...
						}elseif ($visit_jantung["vis_".$i."F"] == "memo1") {
