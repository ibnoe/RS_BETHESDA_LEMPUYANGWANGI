...
$rowPasien = pg_query($con,
            "select a.id, a.nama,a.alm_tetap,a.tipe_desc from rsv_pasien2 a  where a.id = '".(string)$_GET['rg']."'");
...
$result = pg_query($con, "SELECT DISTINCT rs00015.id, rs00015.obat, rs00016.harga, rs00016a.qty_001 AS stok
    FROM rs00015 
...
<script>
    $(function() {
        ...
        $('#list_pemakaian_bhp').load('actions/apotik_bhp_igd_insert.php?rg=<?php echo $_GET['rg'] ?>&fs=qty_001');
        ...
        $('#save-obat').click(function(){
            ...
            $.post('actions/apotik_bhp_igd_insert.php?rg=<?php echo $_GET['rg']?>&fs=qty_001',
                        {
                            rg: valRg,
                            obat_id: valObatId,
                            qty: valQty,
    ...
    function delete_data_obat(id){
         ...
         $.post('actions/apotik_bhp_igd_insert.php?rg=<?php echo $_GET['rg']?>&fs=qty_001&del=true',
                        {
                            obat_id: obatId,
                            qty: qty,
                            rs00008_id: id
    ...
    function delete_data_obat_return(id){
         ...
         $.post('actions/apotik_bhp_igd_insert.php?rg='+valRg+'&fs=qty_001&delreturn=true',
                        {
