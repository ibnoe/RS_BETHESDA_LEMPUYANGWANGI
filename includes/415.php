    ...
    */
    ...
    if (!empty($_GET[mPASIEN])) {
       ...
       $SQL_b = " and b.tipe = '".$_GET["mPASIEN"]."' ";
        ...
        $SQL = "select a.tanggal_trans as tanggal_trans_str, ".
    ...
    $t->ColHeader = array("TANGGAL TRANSAKSI","U N I T","Rp.", "V i e w");
    $t->ColFooter[2] =  number_format($jumlah,2);
    $t->execute();
