...
if (!$GLOBALS['print']){
    ...
    title_excel("posting_coa_pendapatan&tanggal1D=".$_GET['tanggal1D']."&tanggal1M=".$_GET['tanggal1M']."&tanggal1Y=".$_GET['tanggal1Y']."&tanggal2D=".$_GET['tanggal2D']."&tanggal2M=".$_GET['tanggal2M']."&tanggal2Y=".$_GET['tanggal2Y']."&rawat_inap=".$_GET['rawat_inap']."&mRAWAT=".$_GET['mRAWAT']."&dokter=".$_GET['dokter']."&id_dokter=".$_GET['id_dokter']."&mPASIEN=".$_GET['mPASIEN']."");
} else {
    title("<img src='icon/keuangan.gif' align='absmiddle' > Posting Jurnal");
    title_excel("posting_coa_pendapatan&tanggal1D=".$_GET['tanggal1D']."&tanggal1M=".$_GET['tanggal1M']."&tanggal1Y=".$_GET['tanggal1Y']."&tanggal2D=".$_GET['tanggal2D']."&tanggal2M=".$_GET['tanggal2M']."&tanggal2Y=".$_GET['tanggal2Y']."&rawat_inap=".$_GET['rawat_inap']."&mRAWAT=".$_GET['mRAWAT']."&dokter=".$_GET['dokter']."&id_dokter=".$_GET['id_dokter']."&mPASIEN=".$_GET['mPASIEN']."");
}
