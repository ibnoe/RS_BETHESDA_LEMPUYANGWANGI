...
<h2>Laporan Pendaftaran Pasien Rawat Jalan</h2>
...
$rowsPasien = pg_query($con, "SELECT rs00006.id AS no_reg, rs00006.tanggal_reg, rs00006.waktu_reg::time(0) as time, rs00002.mr_no, rs00002.nama, rs00002.alm_tetap as alamat, rs00001.tdesc AS tipe_pasien, A.tdesc AS poli 
                            FROM rs00006
...
<table id="list-pasien" width="100%">
    <thead>
        <tr>
            ...
            <td align="CENTER" class="TBL_HEAD" width="90">Tanggal</td>
            <td align="CENTER" class="TBL_HEAD" width="90">Jam</td>
            <td align="CENTER" class="TBL_HEAD" width="90">No. Reg</td>
    ...
    <tbody>
	    ...
	    <td align="right"><?php echo $row['time']?>&nbsp; &nbsp; &nbsp;</td>
...
$(document).ready(function() { 
	...
	$("#btn_filter").click(function(){
		...
		window.location = 'index2.php?p=lap_registrasi_pasien_rwj&tgl_dari='+tglDari+'&tgl_sampai='+tglSampai+'&tipe_pasien_id='+tipePasienId+'&unit_id='+unitId;
