...
// Tambahan BHP
$POLI=$setting_poli["paru"];
// ======================================

include ("session.php");
echo "<table border=0 width='100%'><tr><td>";
title_print("<img src='icon/rawat-jalan-2.gif' align='absmiddle' >  POLIKLINIK PARU");
title_excel("p_paru&list=".$_GET['list']."&rg=".$_GET['rg']."&poli=".$_GET['poli']."&mr=".$_GET['mr']."&sub=".$_GET['sub']."&act=".$_GET['act']."&polinya=".$_GET['polinya']."&tblstart=".$_GET['tblstart']."");

//title("<img src='icon/rawat-jalan-2.gif' align='absmiddle' >  POLIKLINIK PARU");
echo "</td></tr></table>";
...
if ($_GET["sub"] == "byr") {
        ...
        echo "<br><br><br>";
        $f = new Form("actions/p_paru.insert.php");
        $f->hidden("rg",$_GET["rg"]);
        $f->hidden("mr",$_GET["mr"]);
 ...
 include("rincianobat.php"); 
    	...
    	$T->show(0);
	    	...
	    	$n = pg_num_rows($r);		    	
				...
				if ($_GET['act'] == "edit"){
						...
						$f = new Form("actions/p_paru.insert.php", "POST", "NAME=Form2");
						$f->hidden("act","edit");
    ...
    $f->hidden("list2",tab1);
	    ...
	    if (!$GLOBALS['print']){
	    	...
	    	//title_excel("p_paru&tblstart=".$_GET['tblstart']);
		}else { 
