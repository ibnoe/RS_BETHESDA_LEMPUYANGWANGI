...
echo "\n<script language='JavaScript'>\n";
        ...
        echo "    sWin = window.open('popup/akun1.php?tag=' + tag, 'xWin',".
...
$f = new Form("actions/kas_masuk.insert.php", "POST", "NAME=Form1");
    $f->PgConn = $con;
	...
	$f->hidden("f_no_invoice","No. Invoice",15,15,"","");
	...
	$t2->SQL = "SELECT to_char(tanggal,'dd Mon yyyy')as tanggal	,a.no_faktur,a.no_invoice,a.kode_trans||' - '||b.nama,a.keterangan ,a.jumlah FROM kas_masuk a,akun_master b where a.kode_trans=b.kode";
        if (!isset($_GET[sort])) {
           $_GET[sort] = "tanggal";
           $_GET[order] = "asc";
	}
