...
if ($_GET["kas"] == "rj") {
    $jenisKwitansi =  "KWITANSI RINCIAN RAWAT JALAN";
} elseif ($_GET["kas"] == "ri") {
    $jenisKwitansi = "KWITANSI RINCIAN RAWAT INAP";
} else {
    $jenisKwitansi = "KWITANSI RINCIAN IGD";
}
?>
...
//==========
                ...
                <td width="100%">
                        ...
                        <table class="none" cellpadding="0" cellspacing="0">
							...
							<tr>
                                ...
                                <td class="add-bold"><font size="1"  face="Tahoma">:</td>
                                <td class="add-bold"><font size="1"  face="Tahoma"><? echo $dt->id;?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><font size="1"  face="Tahoma"><? echo $rawatan; ?></td>
                                <td><font size="1"  face="Tahoma">:</td>
                                <td><font size="1"  face="Tahoma"><? echo $poli; ?></td>
                            </tr>
                        </table>
    ...
    <table style="width: 100% !important;" cellpadding="0" cellspacing="0" border=1>
        <tr>
            <td align="center"><b><font size="1"  face="Tahoma">Rincian Pembayaran <? echo $kasir; ?></b></font></td>
        </tr>
    </table>
    <?
    ...
    <table width="100%"  class="items" cellpadding="0" cellspacing="0">
        <tbody>
            <tr>
                ...
                <td width="10%"><font size="1"  face="Tahoma">JUMLAH</td>
            ...
            ?>
                ...
                <tr>
                    <td  align="center">&nbsp;</td>
                    <td  align="left"><b><u><font size="1"  face="Tahoma">RINCIAN PAKET LAYANAN</u></b></td>
                    <td  align="center">&nbsp;</td>
                    <td  align="center">&nbsp;</td>
                    <td  align="right">&nbsp;</td>
            ...
            ?>
                        ...
                        <tr>
                            ...
                            <td  align="left"><b><font size="1"><font size="1"  face="Tahoma">PAKET LAYANAN <?= $row1["description"] ?></b></td>
...
// Rincian Layanan Non Paket
            ...
            if ($rec1 > 0) {
				...
				where f.no_reg = '$reg' 
				order by tanggal_trans, waktu_entry desc ";
				//echo $sqle;
...
// Pembelian BHP
		...
		group by  d.tdesc, a.tanggal_trans, a.id, b.obat, a.qty, a.pembayaran, a.trans_group, c.tdesc, a.trans_form order by tanggal_trans, waktu_entry desc ";
		...
		group by  d.tdesc, a.tanggal_trans, a.id, b.obat, a.qty, a.pembayaran, a.trans_group, c.tdesc, a.trans_form order by tanggal_trans, waktu_entry desc ";
            ...
            ?>
                        <tr>
                            ...
                            <td  align="left"><font size="1"  face="Tahoma"><?= $row5["obat"] ?></td>
							<td  align="right">&nbsp;</td>
                            <td  align="left"><font size="1"  face="Tahoma"><?= $row5["qty"] ?></td>
                            <td  align="right"><font size="1"  face="Tahoma"><?= number_format($row5["tagihan"], 2, ",", ".") ?></td>
...
// Pembelian Obat Racikan
		...
		and b.kategori_id = d.tc and d.tt = 'GOB' 
		and to_number(a.no_reg,'999999999999')= $reg  and referensi != 'F'
		group by  d.tdesc, a.tanggal_trans, a.id, b.obat, a.qty, a.pembayaran, a.trans_group, c.tdesc, a.trans_form order by tanggal_trans";
            ...
            ?>
                        <tr>
                            ...
                            <td class="TBL_BODY2" align="left"><font size="1"  face="Tahoma"><?= $row6["obat"] ?></td>
							<td  align="right">&nbsp;</td>
                            <td class="TBL_BODY2" align="left"><font size="1"  face="Tahoma"><?= $row6["qty"] ?></td>
                            <td class="TBL_BODY2" align="right"><font size="1"  face="Tahoma"><?= number_format($row6["tagihan"], 2, ",", ".") ?></td>
			...
			//OBAT RETUR
			 ...
			 $rec10 = getFromTable("select count(id) from rs00008_return " .
                            "where trans_type = 'OB1' and to_number(no_reg,'999999999999') = $reg" );


            if ($rec10 > 0) {
                $sqlret = "select a.id, ".
				//to_char(tanggal_trans,'DD-MM-YYYY') as tanggal_trans,
		"obat, qty_return ||' '|| c.tdesc as qty, sum(a.tagihan) as tagihan_retur,  trans_group, d.tdesc as kategori, a.trans_form 
		...
		group by  d.tdesc, a.tanggal_trans, a.id, b.obat, a.qty_return,  a.trans_group, c.tdesc, a.trans_form order by a.tanggal_trans";
                @$r10 = pg_query($con, $sqlret);
                @$n10 = pg_num_rows($r10);
            ...
            ?>
                <tr class="items">
                    ...
                    <td colspan='2' align="left"><b><u><font size="1"  face="Tahoma"><br/><br/>RINCIAN RETUR OBAT APOTEK</u></b></td>
                    <td  align="center">&nbsp;</td>
                    <td  align="center">&nbsp;</td>
                    <td  align="right">&nbsp;</td>
            ...
            ?>
                        <tr>
                            ...
                            <td  align="left"><font size="1"  face="Tahoma"><?//= $row10["tanggal_trans"] ?>&nbsp;&nbsp;<?= $row10["obat"] ?></td>
							<td  align="right">&nbsp;</td>
                            <td  align="left"><font size="1"  face="Tahoma"><?= $row10["qty"] ?></td>
                            <td  align="right"><font size="1"  face="Tahoma"><?= number_format($row10["tagihan_retur"], 2, ",", ".") ?></td>

                        </tr>
            <?
                        

                        $totalretur=$totalretur- $row10["tagihan_retur"];
                        $j10++;
                    }
...
$tgl_pos = getFromTable("select max(d.ts_calc_stop::date) from rsv_akomodasi_inap d where d.no_reg='$reg'");	
		...
		if ($rec5 > 0){
		$sqlg= "SELECT id,tanggal(tanggal_trans,3) AS tgl_trans, tanggal_entry, to_char(waktu_entry, 'HH:MI:SS') as waktu_entry, klasifikasi_tarif, bangsal, ruangan,bed, no_reg,nama, qty, diskon, persen, harga, tagihan, 
        dibayar_penjamin FROM rsv_akomodasi_inap_kasir WHERE no_reg='$reg' ORDER BY tanggal_trans";
		...
		?>
		<tr>
		<td class="TBL_BODY" align="left"><b><u><font size="1"  face="Tahoma">TAGIHAN AKOMODASI <?=$tgl_masuk?> s/d <? echo  $tgl_pos;?></u></b></td>
		<td class="TBL_BODY" align="center">&nbsp;</td>
		<td class="TBL_BODY" align="center">&nbsp;</td>
		<td class="TBL_BODY" align="center">&nbsp;</td>
		<td class="TBL_BODY" align="right">&nbsp;</td>
		...
		<tr>
			...
			<td class="TBL_BODY" align="left"><font size="1"  face="Tahoma"><?=$row7["ruangan"] ?></td>
			<td class="TBL_BODY" align="center">&nbsp;</td>
			<td class="TBL_BODY" align="left"><font size="1"  face="Tahoma"><?=$row7["qty"] ?> HARI</td>
			<td class="TBL_BODY" align="right"><b><font size="1"  face="Tahoma"><?=number_format($row7["qty"] * $row7["harga"],2,",",".") ?></b></td>
			
		</tr>
		<?
		$tagihan7=$tagihan7+$row7["qty"] * $row7["harga"];		 
...
// TAGIHAN SEMENTARA AKOMODASI
                ...
                $r1 = pg_query($con,
                                ...
                                "    join rs00012 as e on substr(b.hierarchy,1,3) || '000000000000' = e.hierarchy " .
                                "    join rs00001 as c on d.klasifikasi_tarif_id = c.tc and c.tt = 'KTR' " .
                                "where to_number(a.no_reg,'9999999999') = $reg and ts_calc_stop is null and (extract(day from current_timestamp - a.ts_calc_start)) > 0
		");
                if ($d1 = pg_fetch_object($r1)) {
                    if ($d1->harga > 0) {
                        ...
                        echo "<td class=TITLE_SIM3 colspan=3><B>AKOMODASI " .
                        date("d-m-Y", pgsql2mktime($d1->ts_check_in)) . "   s/d   " .
                        date("d-m-Y") .
                        "  (BELUM POSTING)</B></td><td  align='right'>&nbsp;</td>";
                        echo "</tr>";

                        echo "<tr>";
                        echo "<td class=TITLE_SIM3>&nbsp;</td>";
                        //echo "<td class=TITLE_SIM3>&nbsp;</td>";
                        echo "<td class=TITLE_SIM3>$d1->bangsal / $d1->ruangan / " .
                        "$d1->bed / $d1->klasifikasi_tarif</td><td  align='right'>&nbsp;</td>";
 ...
 */
            ...
            $askesretur=getFromTable("select sum(dibayar_penjamin) from rs00008_return where  no_reg='$reg' ");
            $totalretur=getFromTable("select sum(tagihan) from rs00008_return where  no_reg='$reg' ");
            ...
            $total=$tagihan + $tagihan2 + $tagihan5 + $tagihan5a + ($tagihan6-$totalretur) + $tagihan7;
			...
			<?php
				//--pembulatan
				$totalPembulatan = pembulatan($bayar + $cek_deposit);
				$pembulatan = $totalPembulatan - ($bayar + $cek_deposit);
				//--
			?>

            <tr >
                <td class="TBL_BODY2" align="right" colspan="3"><b><font size="2"  face="Tahoma">TOTAL  TAGIHAN :</b></td>
                <td class="TBL_BODY2" align="right"><b><font size="2"  face="Tahoma"><?= number_format($total, 2, ",", ".") ?></b></td>

            </tr class="title">
            <? if ($cek_deposit > 0) {
            ?>
                <tr>
                    <td class="TBL_BODY2" align="right" colspan="3"><b><font size="1"  face="Tahoma">TOTAL DEPOSIT PASIEN :</b></td>
                    <td class="TBL_BODY2" align="right"><b><font size="1"  face="Tahoma"><?= number_format($cek_deposit, 2, ",", ".") ?></b></td>
                </tr class="title">
            <? } ?>
            <tr>
                <td class="TBL_BODY2" align="right" colspan="3"><b><font size="1"  face="Tahoma">PEMBAYARAN :</b></td>
                <td class="TBL_BODY2" align="right"><b><font size="1"  face="Tahoma"><font size="1"  face="Tahoma"><?= number_format(($bayar + $cek_deposit), 2, ",", ".") ?></b></td>
            </tr class="title">
            <tr>
                <td class="TBL_BODY2" align="right" colspan="3"><b><font size="1"  face="Tahoma">PEMBULATAN :</b></td>
                <td class="TBL_BODY2" align="right"><b><font size="1"  face="Tahoma"><font size="1"  face="Tahoma"><?= number_format($pembulatan, 2, ",", ".") ?></b></td>
            </tr class="title">
            <tr>
                <td class="TBL_BODY2" align="right" colspan="3"><b><font size="1"  face="Tahoma">&nbsp;</b></td>
                <td class="TBL_BODY2" align="right"><b><font size="2"  face="Tahoma"><font size="2"  face="Tahoma">&nbsp;</b></td>
            </tr class="title">
			<tr>
                <td class="TBL_BODY2" align="right" colspan="3"><b><font size="2"  face="Tahoma">TOTAL :</b></td>
                <td class="TBL_BODY2" align="right"><b><font size="2"  face="Tahoma"><font size="2"  face="Tahoma"><?= number_format($totalPembulatan, 2, ",", ".") ?></b></td>
            </tr class="title">
			<tr>
                <td class="TBL_BODY2" align="right" colspan="3"><b><font size="2"  face="Tahoma">TUNAI :</b></td>
                <td class="TBL_BODY2" align="right"><b><font size="2"  face="Tahoma"><font size="2"  face="Tahoma"><?= number_format($cashPembayaran, 2, ",", ".") ?></b></td>
            </tr class="title">
			<tr>
                <td class="TBL_BODY2" align="right" colspan="3"><b><font size="2"  face="Tahoma">KEMBALI :</b></td>
                <td class="TBL_BODY2" align="right"><b><font size="2"  face="Tahoma"><font size="2"  face="Tahoma"><?= number_format($cashPengembalian, 2, ",", ".") ?></b></td>
            </tr class="title">
			<? if ($askes > 0) { ?>
            <tr class="title">
                <td class="TBL_BODY2" align="right" colspan="3"><font size="1"  face="Tahoma"><b>TOTAL DIBAYAR PENJAMIN :</b></td>
                <td class="TBL_BODY2" align="right"><b><font size="1"  face="Tahoma"><?= number_format($askes, 2, ",", ".") ?></b></td>
            </tr class="title">
			<? } ?>
			<? if ($potongan > 0) { ?>
            <tr class="title">
                <td class="TBL_BODY2" align="right" colspan="3"><font size="1"  face="Tahoma"><b>TOTAL POTONGAN :</b></td>
                <td class="TBL_BODY2" align="right"><font size="1"  face="Tahoma"><b><font size="1"  face="Tahoma"><?= number_format($potongan, 2, ",", ".") ?></b></td>
            </tr class="title">
			<? } ?>
            <? 
            ...
            ?>
                <tr >
                    <td class="TBL_BODY2" align="right" colspan="3"><font size="1"  face="Tahoma"><b>SISA PEMBAYARAN :</b></td>
                    <td class="TBL_BODY2" align="right"><b><font size="1"  face="Tahoma"><?= number_format(($d2->sisa)-$totalretur, 2, ",", ".") ?></b></td>
...
//include("cetak.inc.php");
    ...
    <table border="0" align="left" width="50%" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td align="center" class="TITLE_SIM3"><u><font size="2"  face="Tahoma"><?=$set_header[0]?></u></td>
        </tr>
        <tr>
            <td align="center" class="TITLE_SIM3"><u><font size="2"  face="Tahoma"><?=$set_header[1]?></u></td>
        </tr>
    </table>
