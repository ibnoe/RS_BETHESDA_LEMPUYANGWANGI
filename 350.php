...
<?php
title("<img src='icon/rawat-inap-2.gif' align='absmiddle' >  PENGADAAN FARMASI");
echo "<br>";
...
$no_po = str_pad(((int) ($po_id+1)), 4, "0", STR_PAD_LEFT);
//echo $no_po;
...
if ($_SESSION["ob4"]["nomor-po"] != $cek_po && $_SESSION["ob4"]["tanggal-pengadaan"]!='' && $_SESSION["ob4"]["penanggung-jawab"]!='' && $_SESSION["ob4"]["ppn"]!='' ) {
    ...
    echo "    sWin = window.open('popup/obat_gudang2.php', 'xWin', 'width=550,height=400,menubar=no,scrollbars=yes');\n";
    echo "    sWin.focus();\n";
    echo "}\n";
    echo "</script>\n";	
