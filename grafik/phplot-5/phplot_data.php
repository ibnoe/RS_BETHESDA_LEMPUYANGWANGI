<?php
/* $Id: phplot_data.php,v 1.11 2004/01/24 22:18:11 migueldb Exp $
 * 
...
class PHPlot_Data extends PHPlot 
{
     ...
     * Constructor
     */
    function PHPlot_Data($which_width=700, $which_height=500, $which_output_file=NULL, $which_input_file=NULL)
    { 
        if (! isset($this->img)) { 
